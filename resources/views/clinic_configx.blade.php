    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <form method="POST" action="" accept-charset="UTF-8" id="frmMain" class="form-horizontal" enctype="multipart/form-data" @submit.prevent="clinicSubmit()">
                            @csrf
                            <!-- <input name="_token" type="hidden" value="i3DQdQEPNCsUOOwzEQ9h2xRoirkIzqhAF3EOexOD"> -->
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-3 col-md-10">
                                                <input class="btn btn-primary" style="width: 135px; margin-top: 1rem;" type="submit" value="Save">
