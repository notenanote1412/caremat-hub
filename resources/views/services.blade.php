    ...
    <div class="service_section">
        <div class="container">
            ...
            <form action="/select_service" method="POST">
                @csrf
                <div class="all-cards" style="zoom: 50%">
                    <label class="container">
                        ...
                        <div class="custom-checkbox">
                            ...
                            <div class="card-label" style="font-size: 2.5rem;">ตรวจเลือด เอชไอวี ซิฟิลิส</div>
                        </div>
                    </label>
                    ...
                    <label class="container">
                        ...
                        <div class="custom-checkbox">
                            ...
                            <div class="card-label" style="font-size: 2.5rem;">รับยาเพร็พ</div>
                        </div>
                    </label>
                    ...
                    <label class="container">
                        ...
                        <div class="custom-checkbox">
                            ...
                            <div class="card-label" style="font-size: 2.5rem;">ตรวจฮอร์โมนเพศ</div>
                        </div>
                    </label>
                    ...
                    <label class="container">
                        ...
                        <div class="custom-checkbox">
                            ...
                            <div class="card-label" style="font-size: 2.5rem;">ตรวจ Hep B</div>
                        </div>
                    </label>
                    ...
                    <label class="container">
                        ...
                        <div class="custom-checkbox">
                            ...
                            <div class="card-label" style="font-size: 2.5rem;">ตรวจ Hep C</div>
                        </div>
                    </label>
                    ...
                    <label class="container">
                        ...
                        <div class="custom-checkbox">
                            ...
                            <div class="card-label" style="font-size: 2.5rem;">ขอคำปรึกษา อื่นๆ</div>
                        </div>
                    </label>
                </div>
