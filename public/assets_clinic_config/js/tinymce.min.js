...
!(function () {
  ...
  var fe,
    ...
    He = function (e, t, n) {
      ...
      if (n.domLoaded) t(o)
        ...
        !r.addEventListener || (_e.ie && _e.ie < 11)
            ...
            ? function (e, t) {
                ...
                return (
                  ...
                  (!me.sortDetached && t.compareDocumentPosition(e) === n)
                    ? e === s || (e.ownerDocument === We && Re(We, e))
                      ? -1
                      : t === s || (t.ownerDocument === We && Re(We, t))
                      ? 1
                      : xe
  ...
  (Tt.contains = function (e, t) {
    return (e.ownerDocument || e) !== Ee && Ne(e), Re(e, t)
  }),
  ...
  var Sn = function (n) {
    ...
    On = {
      unknown: function () {
        return Bn({ current: undefined, version: Rn.unknown() })
      },
      nu: Bn,
      edge: H('Edge'),
      chrome: H('Chrome'),
    ...
    Dr = function (e, t) {
      return _r(e, t, Rr().DOCUMENT_POSITION_CONTAINED_BY)
    },
    Br = tr.ELEMENT,
    Or = tr.DOCUMENT,
    Pr = function (e) {
        ...
        return n
          ...
          : ('float' ===
              (t = t.replace(/-(\D)/g, function (e, t) {
                return t.toUpperCase()
              })) && (t = _e.ie && _e.ie < 12 ? 'styleFloat' : 'cssFloat'),
  ...
  var Yi,
    ...
    Ta = Ea,
    ka = function (e) {
      return e.replace(new RegExp(Ea, 'g'), '')
    },
    Aa = Do.isElement,
    Ra = Do.isText,
    _a = function (e) {
      return (
        Ra(e) && (e = e.parentNode), Aa(e) && e.hasAttribute('data-mce-caret')
      )
    },
    Da = function (e) {
      return Ra(e) && Sa(e.data)
    },
    Ba = function (e) {
      return _a(e) || Da(e)
    },
    ...
    Pa = function (e) {
      var t = e.container()
      return e && Do.isText(t) && t.data.charAt(e.offset()) === Ta
    },
    La = function (e) {
      var t = e.container()
      return e && Do.isText(t) && t.data.charAt(e.offset() - 1) === Ta
    },
    Ia = function (e, t, n) {
      var r, o, i
      return (
    ...
    Ma = function (e) {
      return Ra(e) && e.data[0] === Ta
    },
    Fa = function (e) {
      return Ra(e) && e.data[e.data.length - 1] === Ta
    },
    Ua = function (e) {
    ...
    za = Do.isContentEditableTrue,
    Va = Do.isContentEditableFalse,
    qa = Do.isBr,
    Ha = Do.isText,
    ja = Do.matchNodeNames('script style textarea'),
    $a = Do.matchNodeNames('img input textarea hr iframe video audio object'),
    Wa = Do.matchNodeNames('table'),
    Ka = Ba,
    Xa = function (e) {
      return (
        !Ka(e) && (Ha(e) ? !ja(e.parentNode) : $a(e) || qa(e) || Wa(e) || Ya(e))
      )
    },
    Ya = function (e) {
      return (
        !1 ===
          ((t = e),
          Do.isElement(t) && 'true' === t.getAttribute('unselectable')) && Va(e)
      )
      var t
    },
    Ga = function (e) {
    ...
    cu = Do.isElement,
    lu = Xa,
    fu = Do.matchStyleValues('display', 'block table'),
    du = Do.matchStyleValues('float', 'left right'),
    mu = Na.and(cu, lu, Na.negate(du)),
    gu = Na.negate(Do.matchStyleValues('white-space', 'pre pre-line pre-wrap')),
    pu = Do.isText,
    hu = Do.isBr,
    vu = pi.nodeIndex,
    bu = iu,
    ...
    Tu = function (e) {
      var t,
        ...
        i = function (e, t) {
          var n = yu(e.ownerDocument)
          if (t < e.data.length) {
            if (uu(e.data[t])) return r
            if (
              uu(e.data[t - 1]) &&
              (n.setStart(e, t), n.setEnd(e, t + 1), !wu(n))
            )
              return o(Su(Eu(n), !1)), r
          }
          0 < t &&
            (n.setStart(e, t - 1), n.setEnd(e, t), wu(n) || o(Su(Eu(n), !1))),
            t < e.data.length &&
              (n.setStart(e, t), n.setEnd(e, t + 1), wu(n) || o(Su(Eu(n), !0)))
        }
      if (pu(e.container())) return i(e.container(), e.offset()), r
      if (cu(e.container()))
        if (e.isAtEnd())
          (n = bu(e.container(), e.offset())),
            pu(n) && i(n, n.data.length),
            mu(n) && !hu(n) && o(Su(Eu(n), !1))
        else {
          if (
            ((n = bu(e.container(), e.offset())),
            pu(n) && i(n, 0),
            ...
            return o(Su(Eu(n), !1)), r
          ;(t = bu(e.container(), e.offset() - 1)),
            mu(t) && !hu(t) && (fu(t) || fu(n) || !mu(n)) && o(Su(Eu(t), !1)),
            mu(n) && o(Su(Eu(n), !0))
        }
      return r
    }
  function ku(t, n, e) {
    var r = function () {
      return e || (e = Tu(ku(t, n))), e
    }
    return {
      container: Na.constant(t),
      offset: Na.constant(n),
      toRange: function () {
        var e
        return (e = yu(t.ownerDocument)).setStart(t, n), e.setEnd(t, n), e
      },
      getClientRects: r,
      isVisible: function () {
        return 0 < r().length
      ...
      isAtEnd: function () {
        return pu(t) ? n >= t.data.length : n >= t.childNodes.length
      },
      isEqual: function (e) {
  ...
  ;((Yi = ku || (ku = {})).fromRangeStart = function (e) {
    ...
    (Yi.after = function (e) {
      return Yi(e.parentNode, vu(e) + 1)
    }),
    (Yi.before = function (e) {
      return Yi(e.parentNode, vu(e))
    }),
    (Yi.isAbove = function (e, t) {
      return su([ee(t.getClientRects()), te(e.getClientRects())], nu).getOr(!1)
    }),
    (Yi.isBelow = function (e, t) {
      return su([te(t.getClientRects()), ee(e.getClientRects())], ru).getOr(!1)
    }),
  ...
  var Au,
    ...
    Mu = function (e) {
      var t, r, n, o
      return (
        (Du(e) ? 'text()' : e.nodeName.toLowerCase()) +
        '[' +
        ((r = Lu(Pu((t = e)))),
        (n = jt.findIndex(r, Iu(t), t)),
        (r = r.slice(0, n + 1)),
        (o = jt.reduce(
          r,
          function (e, t, n) {
            return Du(t) && Du(r[n - 1]) && e++, e
          },
          0
        )),
        (r = jt.filter(r, Do.matchNodeNames(t.nodeName))),
        (n = jt.findIndex(r, Iu(t), t)) - o) +
        ']'
      )
    },
    Fu = function (e, t) {
      ...
      return (
        ...
        Du(n)
          ? (o = (function (e, t) {
              for (; (e = e.previousSibling) && Du(e); ) t += e.data.length
              return t
            })(n, r))
        ...
        (a = jt.filter(a, Na.negate(Do.isBogus))),
        (u = u.concat(
          jt.map(a, function (e) {
            return Mu(e)
          })
          ...
          (r = jt.reduce(
            ...
            ? Du(r)
              ? (function (e, t) {
                  ...
                  return (
                    Du(e) && t > e.data.length && (t = e.data.length), _u(e, t)
                  )
                })(r, parseInt(o, 10))
              : ((o = 'after' === o ? Ou(r) + 1 : Ou(r)), _u(r.parentNode, o))
            : null)
        : null
    },
    zu = Do.isContentEditableFalse,
    ...
    Wu = function (e, t) {
      var n
      if (Do.isElement(e) && ((e = iu(e, t)), zu(e))) return e
      if (Ba(e)) {
        if (
          (Do.isText(e) && _a(e) && (e = e.parentNode),
          (n = e.previousSibling),
          zu(n))
        )
          return n
        if (((n = e.nextSibling), zu(n))) return n
      }
    },
    Ku = function (e, t, n) {
      var r = n.getNode(),
        o = r ? r.nodeName : null,
        i = n.getRng()
      if (zu(r) || 'IMG' === o) return { name: o, index: Hu(n.dom, o, r) }
      var a,
        u,
        s,
        c,
        ...
        d,
        m =
          Wu((a = i).startContainer, a.startOffset) ||
          Wu(a.endContainer, a.endOffset)
      return m
        ? { name: (o = m.tagName), index: Hu(n.dom, o, m) }
        : ((u = e),
          (c = t),
          (l = i),
          (f = (s = n).dom),
          ((d = {}).start = Vu(f, u, c, l, !0)),
          s.isCollapsed() || (d.end = Vu(f, u, c, l, !1)),
          d)
    },
    Xu = function (e, t, n) {
      var r = {
    ...
    Yu = function (e, t) {
      var n = e.dom,
        ...
        a = e.getNode(),
        u = a.nodeName
      if ('IMG' === u) return { name: u, index: Hu(n, u, a) }
      var s = $u(r.cloneRange())
      if (!i) {
        s.collapse(!1)
        var c = Xu(n, o + '_end', t)
        s.insertNode(c), qu(c.nextSibling)
      }
      ;(r = $u(r)).collapse(!0)
      var l = Xu(n, o + '_start', t)
      return (
        r.insertNode(l),
        qu(l.previousSibling),
        qu(l.nextSibling),
    ...
    Gu = {
      getBookmark: function (e, t, n) {
        return 2 === t
          ...
          ? ((o = (r = e).getRng()),
            {
              start: Fu(r.dom.getRoot(), _u.fromRangeStart(o)),
              end: Fu(r.dom.getRoot(), _u.fromRangeEnd(o)),
            })
          : t
          ? { rng: e.getRng() }
          : Yu(e, !1)
      ...
      getUndoBookmark: b(Ku, j, !0),
      getPersistentBookmark: Yu,
    },
    Ju = '_mce_caret',
    Qu = function (e) {
      return Do.isElement(e) && e.id === Ju
    },
    Zu = function (e, t) {
      for (; t && t !== e; ) {
        if (t.id === Ju) return t
    ...
    us = function (e, t) {
      return ts(e) && t.container() === e
        ? ((r = t),
          (o = os((n = e).data.substr(0, r.offset()))),
          (i = os(n.data.substr(r.offset()))),
          0 < (a = o.text + i.text).length
            ? (rs(n, a), _u(n, r.offset() - o.count))
            : r)
        : is(e, t)
      var n, r, o, i, a
    },
    ss = function (e) {
      if (
        (es(e) &&
          Ba(e) &&
          (Oa(e) ? e.removeAttribute('data-mce-caret') : ns(e)),
        ts(e))
      ) {
        var t = ka(
          (function (e) {
    ...
    cs = {
      removeAndReposition: function (e, t) {
        return _u.isTextPosition(t)
          ? us(e, t)
          : ((n = e),
            (r = t).container() === n.parentNode ? as(n, r) : is(n, r))
        var n, r
      },
      remove: ss,
    },
    ls = Do.isContentEditableTrue,
    fs = Do.isContentEditableFalse,
    ...
    gs = function (e, t, n) {
      var r = tl(1, e.getBody(), t),
        ...
        i = o.getNode()
      if (fs(i)) return ds(1, e, i, !o.isAtEnd(), !1)
      var a = o.getNode(!0)
      if (fs(a)) return ds(1, e, a, !1, !1)
      var u = e.dom.getParent(o.getNode(), function (e) {
        return fs(e) || ls(e)
      })
      return fs(u) ? ds(1, e, u, !1, n) : null
    },
    ps = function (e, t, n) {
  ...
  ;((Ru = Au || (Au = {}))[(Ru.Backwards = -1)] = 'Backwards'),
    (Ru[(Ru.Forwards = 1)] = 'Forwards')
  var hs,
    vs,
    bs = Do.isContentEditableFalse,
    ys = Do.isText,
    Cs = Do.isElement,
    xs = Do.isBr,
    ws = Xa,
    ...
    Ts = function (e, t) {
      if (jc(e)) {
        if (ws(t.previousSibling) && !ys(t.previousSibling)) return _u.before(t)
        if (ys(t)) return _u(t, 0)
      }
      if ($c(e)) {
        if (ws(t.nextSibling) && !ys(t.nextSibling)) return _u.after(t)
        if (ys(t)) return _u(t, t.data.length)
      }
      return $c(e) ? (xs(t) ? _u.before(t) : _u.after(t)) : _u.before(t)
    },
    ks = function (e, t, n) {
      var r, o, i, a, u
      ...
      if (t.isEqual(_u.after(n)) && n.lastChild) {
        if (
          ...
          $c(e) && ws(n.lastChild) && Cs(n.lastChild))
        )
          return xs(n.lastChild) ? _u.before(n.lastChild) : u
      } else u = t
      var s,
        c,
        l,
        ...
        d = u.offset()
      if (ys(f)) {
        if ($c(e) && 0 < d) return _u(f, --d)
        if (jc(e) && d < f.length) return _u(f, ++d)
        r = f
      } else {
        if ($c(e) && 0 < d && ((o = Ss(f, d - 1)), ws(o)))
          return !Ns(o) && (i = Kc(o, e, Es, o))
            ? ys(i)
              ? _u(i, i.data.length)
              : _u.after(i)
            : ys(o)
            ? _u(o, o.data.length)
            : _u.before(o)
        if (jc(e) && d < f.childNodes.length && ((o = Ss(f, d)), ws(o)))
          return xs(o) && n.lastChild === o
            ? null
            : ((s = o),
              (c = n),
              Do.isBr(s) &&
              !Ga(s.nextSibling) &&
              (l = ks(Au.Forwards, _u.after(s), c)) &&
              !Yc(_u.before(s), _u.before(l), c)
                ? ks(e, _u.after(o), n)
                : !Ns(o) && (i = Kc(o, e, Es, o))
                ? ys(i)
                  ? _u(i, 0)
      ...
      return ((jc(e) && u.isAtEnd()) || ($c(e) && u.isAtStart())) &&
        ((r = Kc(r, e, Na.constant(!0), n, !0)), Es(r, n))
        ? Ts(e, r)
        : ((o = Kc(r, e, Es, n)),
          !(a = jt.last(
            jt.filter(
          ...
          (o && a.contains(o))
            ? o
              ? Ts(e, o)
              : null
            : (u = jc(e) ? _u.after(a) : _u.before(a)))
    },
    As = function (t) {
      return {
        next: function (e) {
          return ks(Au.Forwards, e, t)
        },
        prev: function (e) {
          return ks(Au.Backwards, e, t)
        },
      }
    }
  ;((vs = hs || (hs = {}))[(vs.Br = 0)] = 'Br'),
  ...
  var Rs,
    ...
    Os,
    Ps = function (e, t) {
      return e === Au.Backwards ? t.reverse() : t
    },
    Ls = function (e, t, n, r) {
      for (
        var o, i, a, u, s, c, l = As(n), f = r, d = [];
        f &&
        ((s = l), (c = f), (o = t === Au.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (Do.isBr(o.getNode(!1)))
          return t === Au.Forwards
            ? {
                positions: Ps(t, d).concat([o]),
                breakType: hs.Br,
                breakAt: A.some(o),
              }
            : { positions: Ps(t, d), breakType: hs.Br, breakAt: A.some(o) }
        if (o.isVisible()) {
          if (e(f, o)) {
            var m =
              ((i = t),
              (a = f),
              (u = o),
              Do.isBr(u.getNode(i === Au.Forwards))
                ? hs.Br
                : !1 === Yc(a, u)
                ? hs.Block
                : hs.Wrap)
            return { positions: Ps(t, d), breakType: m, breakAt: A.some(o) }
          }
          d.push(o), (f = o)
        } else f = o
      }
      return { positions: Ps(t, d), breakType: hs.Eol, breakAt: A.none() }
    },
    Is = function (n, r, o, e) {
      return r(o, e)
        .breakAt.map(function (e) {
          var t = r(o, e).positions
          return n === Au.Backwards ? t.concat(e) : [e].concat(t)
        })
        .getOr([])
    },
    Ms = function (e, i) {
    ...
    Us = b(Ls, ku.isAbove, -1),
    zs = b(Ls, ku.isBelow, 1),
    Vs = b(Is, -1, Us),
    qs = b(Is, 1, zs),
        ...
        .bind(function (e) {
          return Fs(
            ...
            hl
              .lastPositionIn(t)
              .map(function (e) {
                return Us(t, e).positions.concat(e)
              })
              .getOr([])),
            n
          )
        ...
        .bind(function (e) {
          return Fs(
            ...
            hl
              .firstPositionIn(t)
              .map(function (e) {
                return [e].concat(zs(t, e).positions)
              })
              .getOr([])),
            n
          )
    ...
    Gs = function (d, e) {
      ee(ku.fromRangeStart(e).getClientRects()).each(function (e) {
        var t,
          n,
          r,
          o,
    ...
    tc = function (e) {
      return Js(e, 'body_id', 'tinymce')
    },
    nc = function (e) {
      return Js(e, 'body_class', '')
    },
    rc = function (e) {
    ...
    xc = Qn.detect().browser,
    wc = function () {
      return xc.isIE() || xc.isEdge() || xc.isFirefox()
    },
    Nc = function (e, t) {
      e.selection.setRng(t), Gs(e, t)
    },
    Ec = function (e, t, n) {
      var r,
        o,
        ...
        a,
        u = e(t, n)
      return ((a = u).breakType === hs.Wrap && 0 === a.positions.length) ||
        (!Do.isBr(n.getNode()) &&
          (i = u).breakType === hs.Br &&
                ...
                return (
                  ...
                  void ((i = ic((r = u)))
                    ? r.undoManager.transact(function () {
                        ...
                        t.setStart(e.dom(), 0), t.setEnd(e.dom(), 0), Nc(r, t)
                      })
                    : Nc(r, t.toRange()))
                )
                var n, r, o, t, i
          ...
          Ws((s = n), (c = f))
            .orThunk(function () {
              return ee(c.getClientRects()).bind(function (e) {
                return Ms(Vs(u, _u.before(s)), e.left)
              })
            })
            .getOr(_u.before(s)))
        return Rc(e, t, m), !0
        ...
        (m = Ks((i = n), (a = f))
          .orThunk(function () {
            return ee(a.getClientRects()).bind(function (e) {
              return Ms(qs(o, _u.after(i)), e.left)
            })
          })
          .getOr(_u.after(i))),
        Rc(e, t, m),
    ...
    Pc = function (e, t, n) {
      var r,
        ...
        a,
        u,
        s = eu(t.getBoundingClientRect(), n)
      return (
        'BODY' === e.tagName
    ...
    Lc = function (a, u, e) {
      ...
      return {
        show: function (t, e) {
          ...
          if (!u(e))
            return (
              (s = (function (e, t) {
                var n, r, o
                if (
                  ((r = e.ownerDocument.createTextNode(Ta)),
                  (o = e.parentNode),
                  t)
                ) {
                  if (((n = e.previousSibling), Ra(n))) {
                    if (Ba(n)) return n
                    if (Fa(n)) return n.splitText(n.data.length - 1)
                  }
                  o.insertBefore(r, e)
                } else {
                  if (((n = e.nextSibling), Ra(n))) {
                    if (Ba(n)) return n
                    if (Ma(n)) return n.splitText(1), n
                  }
                  e.nextSibling
          ...
          ;(s = Ia('p', e, t)), (n = Pc(a, e, t)), pn(s).css('top', n.top)
          var i = pn(
    ...
    Ic = function (e) {
      return Oc(e) || (Do.isTable(e) && wc())
    },
    Mc = Do.isContentEditableFalse,
    Fc = Do.matchStyleValues(
      'display',
    ...
    Wc = function (e, t) {
      for (var n; (n = e(t)); ) if (!zc(n)) return n
      return null
    },
    Kc = function (e, t, n, r, o) {
      var i = new oo(e, r)
      if ($c(t)) {
        if ((Mc(e) || zc(e)) && n((e = Wc(i.prev, !0)))) return e
        for (; (e = Wc(i.prev, o)); ) if (n(e)) return e
      }
      if (jc(t)) {
        if ((Mc(e) || zc(e)) && n((e = Wc(i.next, !0)))) return e
        for (; (e = Wc(i.next, o)); ) if (n(e)) return e
      }
      return null
    },
    Xc = function (e, t) {
    ...
    Yc = function (e, t, n) {
      return Xc(e.container(), n) === Xc(t.container(), n)
    },
    Gc = function (e, t) {
      var n, r
      return t
    ...
    Qc = function (e, t, n) {
      ...
      for (o = e ? 'previousSibling' : 'nextSibling'; n && n !== t; ) {
        if (((r = n[o]), Uc(r) && (r = r[o]), Mc(r))) {
          if (((a = n), Xc(r, (i = t)) === Xc(a, i))) return r
          break
        }
        if (Hc(r)) break
        n = n.parentNode
    ...
    tl = function (e, t, n) {
      ...
      if (((o = n.startContainer), (i = n.startOffset), _a(o))) {
        if (
          ...
          'before' === (a = o.getAttribute('data-mce-caret')) &&
            ((r = o.nextSibling), Ic(r)))
        )
          return Zc(r)
        if ('after' === a && ((r = o.previousSibling), Ic(r))) return el(r)
      }
      ...
      if (Do.isText(o)) {
        ...
        if (Fa(o) && i >= o.data.length - 1)
          return 1 === e && (r = s(o)) ? Zc(r) : n
        if (Ma(o) && i <= 1) return -1 === e && (r = u(o)) ? el(r) : n
    ...
    nl = function (e, t) {
      var n = Gc(e, t)
      return Mc(n) && !Do.isBogusAll(n)
    },
    rl = function (e, t) {
      return Do.isTable(Gc(e, t))
    },
    ol = function (e, t) {
      return A.from(Gc(e ? 0 : -1, t)).filter(Mc)
    },
    il = function (e, t, n) {
      var r = tl(e, t, n)
    ...
    cl = Vc(rl, -1),
    ll = function (e) {
      return _u.isTextPosition(e) ? 0 === e.offset() : Xa(e.getNode())
    },
    fl = function (e) {
    ...
    ml = function (e, t, n) {
      return e
        ? !dl(t, n) &&
            ((r = t), !(!_u.isTextPosition(r) && Do.isBr(r.getNode()))) &&
            fl(t) &&
            ll(n)
        : !dl(n, t) && ll(t) && fl(n)
      var r
    ...
    pl = function (e, t) {
      ...
      return Do.isText(u)
        ? A.some(_u(u, e ? 0 : u.data.length))
        : u
        ? Xa(u)
          ? A.some(
              e
                ? _u.before(u)
                : ((a = u), Do.isBr(a) ? _u.before(a) : _u.after(a))
            )
          : ((r = t),
            (o = u),
    ...
    hl = {
      ...
      navigate: function (t, n, r) {
        return gl(t, n, r).bind(function (e) {
          return Yc(r, e, n) && ml(t, r, e) ? gl(t, n, e) : A.some(e)
        })
      },
      positionIn: pl,
      firstPositionIn: b(pl, !0),
      lastPositionIn: b(pl, !1),
    },
    vl = function (e, t) {
      return (
        !e.isBlock(t) ||
    ...
    bl = function (e, t) {
      return hl.lastPositionIn(e).fold(
        function () {
          return !1
        },
        function (e) {
    ...
    yl = function (e, t, n) {
      return !(
        ...
        !Zu(e, t) ||
        ((o = n),
        (i = (r = t).ownerDocument.createTextNode(Ta)),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        0)
    ...
    Cl = function (e, t, n, r) {
      ...
      if (s) {
        for (a = s[0], i = c, o = s.length - 1; 1 <= o; o--) {
          if (((u = i.childNodes), yl(c, i, r))) return !0
          if (s[o] > u.length - 1) return !!yl(c, i, r) || bl(i, r)
          i = u[s[o]]
        }
      ...
      if (t) {
        if (((v = t), Yt.isArray(v.start)))
          return (
            (p = t),
            (h = (g = b).createRng()),
            Cl(g, !0, p, h) && Cl(g, !1, p, h) ? A.some(h) : A.none()
          )
        if ('string' == typeof t.start)
          return A.some(
            ((f = t),
            (d = (l = b).createRng()),
            (m = Uu(l.getRoot(), f.start)),
            d.setStart(m.container(), m.offset()),
            (m = Uu(l.getRoot(), f.end)),
        ...
        if (t.hasOwnProperty('id'))
          return (
            (s = wl((o = b), 'start', (i = t))),
            (c = wl(o, 'end', i)),
            su([s, ((a = c), (u = s), a.isSome() ? a : u)], function (e, t) {
              var n = o.createRng()
              return (
    ...
    El = function (e, t, n) {
      return Gu.getBookmark(e, t, n)
    },
    Sl = function (t, e) {
      Nl(t, e).each(function (e) {
        t.setRng(e)
      })
    },
    Tl = function (e) {
      ...
      moveStart: function (e, t, n) {
        ...
        if (
          (n.startContainer !== n.endContainer ||
            !kl(n.startContainer.childNodes[n.startOffset])) &&
          1 === u.nodeType
        )
          for (
    ...
    Fl = function (e, t, n, r, o, i) {
      var a, u, s, c
      if (3 === n.nodeType) {
        if (-1 !== (s = Ml(o, i, n, r))) return { container: n, offset: s }
        c = n
      }
      for (
        ...
        if (3 !== u.nodeType || Dl(u.parentNode)) {
          if (e.isBlock(u) || _l.isEq(u, 'BR')) break
        } else if (-1 !== (s = Ml(o, i, (c = u))))
    ...
    zl = function (t, e, n, r) {
      ...
      if ((o && e[0].wrapper && (o = Bl(i, o, 'ul,ol').reverse()[0] || o), !o))
        for (
          o = n;
          o[r] && !i.isBlock(o[r]) && ((o = o[r]), !_l.isEq(o, 'br'));
    ...
    Vl = function (e, t, n, r, o, i, a) {
      ...
      if (
        ...
        (f = e.getRoot()),
        3 === u.nodeType && !Ol(u) && (a ? 0 < r : i < u.nodeValue.length))
      )
        return u
      for (;;) {
    ...
    ql = function (e, t, n, r) {
      ...
      return (
        ...
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((i = Ul(c, n, t, i, 'previousSibling')),
          (u = Ul(c, n, t, u, 'nextSibling'))),
        (n[0].block || n[0].selector) &&
          ((i = zl(e, n, i, 'previousSibling')),
          (u = zl(e, n, u, 'nextSibling')),
          n[0].block &&
            (c.isBlock(i) || (i = Vl(c, n, i, a, u, s, !0)),
            c.isBlock(u) || (u = Vl(c, n, i, a, u, s, !1)))),
    ...
    $l =
      ...
      (Bs = Qn.detect().browser),
      {
        get: function (e) {
          if (!Rs(e))
            throw new Error(
              'Can only get ' + _s + ' value of a ' + _s + ' node'
            )
          return Os(e).getOr('')
        },
        getOption: (Os =
          Bs.isIE() && 10 === Bs.version.major
            ? function (e) {
                try {
                  return Ds(e)
                } catch (oN) {
        ...
        set: function (e, t) {
          if (!Rs(e))
            throw new Error(
              'Can only set raw ' + _s + ' value of a ' + _s + ' node'
            )
          e.dom().nodeValue = t
        },
      }),
    ...
    Kl = function (r, o, i, a) {
      return $r.parent(o).fold(
        ...
        function (e) {
          return 'br' === a || ((n = o), sr.isText(n) && '\ufeff' === Wl(n))
            ? 'valid'
            : ((t = o),
              sr.isElement(t) && Wi.has(t, oa())
                ...
                : Qu(o)
                ? 'caret'
                : _l.isValid(r, i, a) && _l.isValid(r, sr.name(e), i)
                ? 'valid'
                : 'invalid-child')
          var t, n
        }
    ...
    Yl = function (e, t, n, r) {
      var o,
        ...
        s = Xl(t, ['uid']),
        c = er.fromTag('span', e)
      Wi.add(c, oa()), hr.set(c, '' + aa(), u), hr.set(c, '' + ia(), n)
      var l = r(u, s),
        f = l.attributes,
        d = void 0 === f ? {} : f,
        m = l.classes,
        g = void 0 === m ? [] : m
      return hr.setAll(c, d), da(c, g), c
    },
    Gl = function (r, e, t, n, o) {
      var i = [],
        a = Yl(r.getDoc(), o, t, n),
        u = Bi(A.none()),
        s = function () {
        ...
        l = function (e) {
          switch (Kl(r, e, 'span', sr.name(e))) {
            case 'invalid-child':
              ...
              break
            case 'valid':
              var n = u.get().getOrThunk(function () {
                var e = pa(a)
      ...
      return (
        jl(r.dom, e, function (e) {
          var t
          s(), (t = $(e, er.fromDom)), c(t)
        }),
        i
      )
    },
    Jl = function (s, c, l, f) {
      s.undoManager.transact(function () {
        ...
        if (
          ...
          var i = Yl(s.getDoc(), f, c, l.decorate)
          Ca(i, '\xa0'),
            s.selection.getRng().insertNode(i.dom()),
            s.selection.select(i.dom())
        } else {
          var a = Gu.getPersistentBookmark(s.selection, !1),
            u = s.selection.getRng()
          Gl(s, u, c, l.decorate, f), s.selection.moveToBookmark(a)
        }
      })
    }
  function Ql(s) {
  ...
  var Zl = function (e) {
    ...
    tf = function (e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || ef(t))
        ? e.slice(0, -1)
        : e
      var t
    },
    ...
    uf = function (e, o, i, t) {
      var n,
        ...
        N =
          ...
          a),
        E = nf(o, i.startContainer),
        S = tf(Zl(N.firstChild)),
        T = o.getRoot(),
        k = function (e) {
          var t = _u.fromRangeStart(i),
            n = As(o.getRoot()),
            r = 1 === e ? n.prev(t) : n.next(t)
          return !r || nf(o, r.getNode()) !== E
        }
      return k(1)
        ? of(E, S, T)
        : k(2)
    ...
    ff = function (e) {
      ...
      t.length === n.length && F(n, _i.remove)
    },
    df = function (e) {
      _i.empty(e), Ti.append(e, er.fromHtml('<br data-mce-bogus="1">'))
    },
    mf = function (n) {
      $r.lastChild(n).each(function (t) {
        $r.prevSibling(t).each(function (e) {
          lo(n) && mo(t) && lo(e) && _i.remove(t)
        })
      })
    },
    gf = Yt.makeMap
  ...
  var vf = function (a) {
    ...
    bf = function (e) {
      return e.collapsed ? e : vf(e)
    },
    yf = Do.matchNodeNames('td th'),
    Cf = function (e, t) {
      var n,
        r,
        ...
        a = o.startOffset
      o.collapsed &&
        ((n = i), (r = a), Do.isText(n) && '\xa0' === n.nodeValue[r - 1]) &&
        Do.isText(i) &&
        (i.insertData(a - 1, ' '),
        i.deleteData(a, 1),
        o.setStart(i, a),
    ...
    xf = function (e, t, n) {
      ...
      if (
        ...
        w === N &&
          ...
          g.setRng(l)),
          g.isCollapsed() ||
            (e.selection.setRng(bf(e.selection.getRng())),
        ...
        if (
          ((u = r.parse(t, k)), !0 === n.paste && af(e.schema, u) && sf(p, i))
        )
          return (
            (l = uf(o, p, e.selection.getRng(), u)),
        ...
        !(function (e, t) {
              ...
              ;(i = e.previousSibling) && 3 === i.nodeType
                ...
                r &&
                  ...
                  !(o = (function (e) {
                    ...
                    if ((t = As(n.getBody()).next(t))) return t.toRange()
                  })(c))
          ...
          A.from(S.getParent(T, 'td,th')).map(er.fromDom).each(mf),
          e.fire('SetContent', s),
          e.addVisual()
      }
    },
      ...
      var n,
        ...
        o =
          'string' != typeof (n = t)
            ...
            : { content: n, details: {} }
      xf(e, o.content, o.details)
    },
    Nf = kr('sections', 'settings'),
    Ef = Qn.detect().deviceType.isTouch(),
    ...
    _f = function (e, t, n, r) {
      var o,
        i = kf(n.forced_plugins),
        a = kf(r.plugins),
        u = e && Rf(t, 'mobile') ? U(a, b(I, Sf)) : a,
        s = ((o = u), [].concat(kf(i)).concat(kf(o)))
    ...
    Mf = {
      isInlineTarget: function (e, t) {
        var n = Of(e, 'inline_boundaries_selector').getOr('a[href],code')
      ...
      normalizeForwards: b(If, !0),
      normalizeBackwards: b(If, !1),
    ...
    zf = function (i, a, u) {
      return su([hl.firstPositionIn(u), hl.lastPositionIn(u)], function (e, t) {
        var n = Mf.normalizePosition(!0, e),
          r = Mf.normalizePosition(!1, t),
          o = Mf.normalizePosition(!1, a)
        return i
          ? hl
              .nextPosition(u, o)
              .map(function (e) {
    ...
    jf = Do.hasAttribute('data-mce-bookmark'),
    $f = Do.hasAttribute('data-mce-bogus'),
    Wf = Do.hasAttributeValue('data-mce-bogus', 'all'),
    Kf = function (e) {
      return (function (e) {
        var t,
          n,
    ...
    Xf = kr('block', 'position'),
    Yf = kr('from', 'to'),
    Gf = function (e, t) {
      var n = er.fromDom(e),
        r = er.fromDom(t.container())
      return Ff(n, r).map(function (e) {
        return Xf(e, t)
      })
    },
    Jf = function (o, i, e) {
      var t = Gf(o, _u.fromRangeStart(e)),
        n = t.bind(function (e) {
          return hl.fromPosition(i, o, e.position()).bind(function (e) {
            return Gf(o, e).map(function (e) {
              return (
                (t = o),
                (n = i),
                (r = e),
                Do.isBr(r.position().getNode()) && !1 === Kf(r.block())
                  ? hl
                      .positionIn(!1, r.block().dom())
                      .bind(function (e) {
                        return e.isEqual(r.position())
                          ? hl.fromPosition(n, t, e).bind(function (e) {
                              return Gf(t, e)
                            })
                          : A.some(r)
                      })
      ...
      return su([t, n], Yf).filter(function (e) {
        return (
          (r = e),
    ...
    rd = function (e) {
      ...
      return F(r, _i.remove), r
    },
    od = function (e, t) {
      var n = nd(t, e)
      return V(n.reverse(), Kf).each(_i.remove)
    },
    id = function (e, t, n, r) {
      if (Kf(n)) return df(n), hl.firstPositionIn(n.dom())
      var o
      ;(o = r),
        0 ===
      ...
      var i = hl.prevPosition(n.dom(), _u.before(r.dom()))
      return (
        F(rd(t), function (e) {
          Ti.before(r, e)
        }),
    ...
    ad = function (e, t, n) {
      if (Kf(n))
        return _i.remove(n), Kf(t) && df(t), hl.firstPositionIn(t.dom())
    ...
    ud = function (e, t) {
      return Fr.contains(t, e)
        ? ((n = nd(e, t)), A.from(n[n.length - 1]))
        : A.none()
      var n
    },
    sd = function (e, t) {
      hl.positionIn(e, t.dom())
        .map(function (e) {
          return e.getNode()
        })
        .map(er.fromDom)
    ...
    cd = function (e, t, n) {
      return sd(!0, t), sd(!1, n), ud(t, n).fold(b(ad, e, t, n), b(id, e, t, n))
    },
    ld = function (e, t, n, r) {
      return t ? cd(e, r, n) : cd(e, n, r)
    },
    fd = function (t, n) {
      var e,
        r = er.fromDom(t.getBody())
      return (
        (e = Qf(r.dom(), n, t.selection.getRng()).bind(function (e) {
          return ld(r, n, e.from().block(), e.to().block())
        })).each(function (e) {
    ...
    md = function (e, t) {
      var n,
        r,
        o = hl.prevPosition(e.dom(), _u.fromRangeStart(t)).isNone(),
        i = hl.nextPosition(e.dom(), _u.fromRangeEnd(t)).isNone()
      return (
        !(dd((n = e), (r = t).startContainer) || dd(n, r.endContainer)) &&
        o &&
        i
      )
    },
    gd = function (e) {
      ...
      return md(i, a)
        ...
        : ((n = i),
          ...
          su(
            [
              Ff(n, er.fromDom(o.startContainer)),
              Ff(n, er.fromDom(o.endContainer)),
            ],
            function (e, t) {
              return (
                !1 === Fr.eq(e, t) &&
                (o.deleteContents(),
                ld(n, !0, e, t).each(function (e) {
                  r.setRng(e.toRange())
                }),
                !0)
              )
    ...
    pd = function (e, t) {
      return !e.selection.isCollapsed() && gd(e)
    },
    hd = function (a) {
    ...
    bd = function (e, t, n, r) {
      var o = r.getNode(!1 === t)
      return Ff(er.fromDom(e), er.fromDom(n.getNode()))
        .map(function (e) {
          return Kf(e) ? vd.remove(e.dom()) : vd.moveToElement(o)
        })
        .orThunk(function () {
          return A.some(vd.moveToElement(o))
        })
    },
    yd = function (u, s, c) {
      return hl.fromPosition(s, u, c).bind(function (e) {
        return (
          (a = e.getNode()),
          yo(er.fromDom(a)) || ho(er.fromDom(a))
            ...
            : ((t = u),
              (o = e),
              (i = function (e) {
                return fo(er.fromDom(e)) && !Yc(r, o, t)
              }),
              ol(!(n = s), (r = c)).fold(function () {
                return ol(n, o).fold(H(!1), i)
              }, i)
                ? A.none()
        ...
        Do.isElement(a) && a.getAttribute('data-mce-caret') === u
          ? ((t = e),
            ...
            t && Do.isContentEditableFalse(n.nextSibling)
              ? A.some(vd.moveToElement(n.nextSibling))
              : !1 === t && Do.isContentEditableFalse(n.previousSibling)
              ? A.some(vd.moveToElement(n.previousSibling))
              : A.none()).fold(function () {
              return yd(r, e, o)
            }, A.some)
          : yd(r, e, o).bind(function (e) {
              return (
                (t = r),
                (n = o),
                e.fold(
                  function (e) {
                    return A.some(vd.remove(e))
                  },
                  function (e) {
                    return A.some(vd.moveToElement(e))
                  },
                  function (e) {
                    return Yc(n, e, t) ? A.none() : A.some(vd.moveToPosition(e))
                  }
                )
              )
              var t, n
    ...
    wd = function (e) {
      return Xa(e.previousSibling)
        ? A.some(
            ((t = e.previousSibling),
            Do.isText(t) ? _u(t, t.data.length) : _u.after(t))
          )
        : e.previousSibling
        ? hl.lastPositionIn(e.previousSibling)
        : A.none()
      var t
    },
    Nd = function (e) {
      return Xa(e.nextSibling)
        ? A.some(((t = e.nextSibling), Do.isText(t) ? _u(t, 0) : _u.before(t)))
        : e.nextSibling
        ? hl.firstPositionIn(e.nextSibling)
        : A.none()
      var t
    },
    Ed = function (r, o) {
      return wd(o)
        ...
        .orThunk(function () {
          return (
            ...
            hl.prevPosition(e, n).fold(function () {
      ...
      return Nd(r)
        ...
        .orThunk(function () {
          return (
            (e = n),
            (t = r),
            hl.nextPosition(e, _u.after(t)).fold(function () {
    ...
    Td = function (e, t, n) {
      return ((r = e), (o = t), (i = n), r ? Sd(o, i) : Ed(o, i)).map(b(xd, n))
      var r, o, i
    },
    kd = function (t, n, e) {
      e.fold(
    ...
    Rd = function (e) {
      if (Kf(e)) {
        ...
        return _i.empty(e), Ti.append(e, t), A.some(_u.before(t.dom()))
      }
      return A.none()
    },
    _d = function (t, n, e) {
      var r,
        ...
        s =
          ((a = e),
          (o = i),
          su([$r.prevSibling(a), $r.nextSibling(a), o], function (e, t, n) {
            var r,
              o = e.dom(),
              i = t.dom()
            return Do.isText(o) && Do.isText(i)
              ? ((r = o.data.length),
                ...
                _i.remove(t),
                _i.remove(a),
                n.container() === i ? _u(o, r) : n)
              : (_i.remove(a), n)
          }).orThunk(function () {
            return _i.remove(a), o
          }))
    ...
    Dd = function (a, u) {
      ...
      (o = _u.fromRangeStart(r)),
      !1 === t && ul(o)
        ? A.some(vd.remove(o.getNode(!0)))
        : t && al(o)
        ? A.some(vd.remove(o.getNode()))
        : Cd(e, t, o))
        .map(function (e) {
          return e.fold(
            ((o = a),
    ...
    Bd = function (e, t) {
      ...
      return (
        ...
        F(Ki(n, '.mce-offscreen-selection'), _i.remove),
        _d(e, t, er.fromDom(e.selection.getNode())),
        Uf(e),
        !0)
      )
    },
    Od = function (e, t) {
      return e.selection.isCollapsed() ? Dd(e, t) : Bd(e, t)
    },
    Pd = function (e) {
      var t,
        n = (function (e, t) {
    ...
    Ld = Do.isText,
    Id = function (e) {
      return Ld(e) && e.data[0] === Ta
    },
    Md = function (e) {
      return Ld(e) && e.data[e.data.length - 1] === Ta
    },
    Fd = function (e) {
      return e.ownerDocument.createTextNode(Ta)
    },
    Ud = function (e, t) {
      return e
        ? (function (e) {
            if (Ld(e.previousSibling))
              return (
                Md(e.previousSibling) || e.previousSibling.appendData(Ta),
                e.previousSibling
              )
            if (Ld(e)) return Id(e) || e.insertData(0, Ta), e
            var t = Fd(e)
        ...
        : (function (e) {
            if (Ld(e.nextSibling))
              return (
                Id(e.nextSibling) || e.nextSibling.insertData(0, Ta),
                e.nextSibling
              )
            if (Ld(e)) return Md(e) || e.appendData(Ta), e
            var t = Fd(e)
            return (
              e.nextSibling
    ...
    jd = function (n, e) {
      return e.fold(
        function (e) {
          cs.remove(n.get())
          var t = zd(e)
          return n.set(t), A.some(_u(t, t.length - 1))
        },
        function (e) {
    ...
    Xd = function (e, t, n) {
      var r = Mf.normalizeForwards(n),
        o = Kd(t, r.container())
      return Mf.findRootInline(e, o, r).fold(function () {
        return hl
          .nextPosition(o, r)
          .bind(b(Mf.findRootInline, e, o))
          .map(function (e) {
            return Wd.before(e)
          })
      }, A.none)
    ...
    Gd = function (e, t, n) {
      return Mf.findRootInline(e, t, n).filter(b(Yd, t))
    },
    Jd = function (e, t, n) {
      var r = Mf.normalizeBackwards(n)
      return Gd(e, t, r).bind(function (e) {
        return hl.prevPosition(e, r).isNone() ? A.some(Wd.start(e)) : A.none()
      })
    },
    Qd = function (e, t, n) {
      var r = Mf.normalizeForwards(n)
      return Gd(e, t, r).bind(function (e) {
        return hl.nextPosition(e, r).isNone() ? A.some(Wd.end(e)) : A.none()
      })
    },
    Zd = function (e, t, n) {
      var r = Mf.normalizeBackwards(n),
    ...
    em = function (e) {
      return !1 === Mf.isRtl(nm(e))
    },
    tm = function (e, t, n) {
      return $d([Xd, Jd, Qd, Zd], [e, t, n]).filter(em)
    },
    nm = function (e) {
    ...
    om = function (e) {
      return e.fold(Wd.before, Wd.before, Wd.after, Wd.after)
    },
    im = function (n, e, r, t, o, i) {
      return su(
        [Mf.findRootInline(e, r, t), Mf.findRootInline(e, r, o)],
        function (e, t) {
          return e !== t && Mf.hasSameParentBlock(r, e, t)
            ? Wd.after(n ? e : t)
            : i
        }
      ).getOr(i)
    ...
    am = function (e, r) {
      return e.fold(H(!0), function (e) {
        return (n = r), !(rm((t = e)) === rm(n) && nm(t) === nm(n))
        var t, n
      })
    },
    um = function (e, t) {
      return e
        ? t.fold(q(A.some, Wd.start), A.none, q(A.some, Wd.after), A.none)
        : t.fold(A.none, q(A.some, Wd.before), A.none, q(A.some, Wd.end))
    },
    sm = function (a, u, s, c) {
      var e = Mf.normalizePosition(a, c),
        l = tm(u, s, e)
      return tm(u, s, e)
        .bind(b(um, a))
        .orThunk(function () {
          return (
            ...
            (o = l),
            (e = c),
            (i = Mf.normalizePosition(t, e)),
            hl
              .fromPosition(t, r, i)
              .map(b(Mf.normalizePosition, t))
              .fold(
                function () {
                  return o.map(om)
                },
                function (e) {
                  return tm(n, r, e).map(b(im, t, n, r, i, e)).filter(b(am, o))
                }
              )
              .filter(em)
          )
    ...
    fm = (b(sm, !1), b(sm, !0), om),
    dm = function (e) {
      return e.fold(Wd.start, Wd.start, Wd.end, Wd.end)
    },
    mm = function (e) {
      ...
      move: function (a, u, s) {
        return function () {
          return (
            ...
            (i = b(Mf.isInlineTarget, t)),
            lm(e, i, r, o).bind(function (e) {
              return ym(t, n, e)
            })).isSome()
          )
          var t, n, e, r, o, i
            ...
            vm(a) &&
              ...
              (function (e, t) {
                if (
                  ...
                  _u.isTextPosition(n) &&
                    !1 === Mf.isAtZwsp(n) &&
                    (hm(e, cs.removeAndReposition(t.get(), n)), t.set(null))
                }
              })(a, u),
              (function (n, r, o, e) {
                if (r.selection.isCollapsed()) {
                  ...
                  F(t, function (e) {
                    ...
                    cm(n, r.getBody(), t).bind(function (e) {
                      return ym(r, o, e)
                    })
                  })
                }
    ...
    wm = function (t, n) {
      return function (e) {
        return jd(n, e)
          .map(function (e) {
            return xm.setCaretPosition(t, e), !0
          })
          .getOr(!1)
      }
    },
    Nm = function (r, o, i, a) {
      ...
      r.undoManager.ignore(function () {
        ...
        r.selection.setRng(
          ...
          cm(s, u, _u.fromRangeStart(r.selection.getRng()))
            .map(dm)
            .map(wm(r, o))
      }),
        r.nodeChanged()
    ...
    Em = function (n, r, i, o) {
      var e,
        t,
        a = ((e = n.getBody()), (t = o.container()), Xc(t, e) || e),
        u = b(Mf.isInlineTarget, n),
        s = cm(u, a, o)
      return s
        .bind(function (e) {
          return i
            ? e.fold(H(A.some(dm(e))), A.none, H(A.some(fm(e))), A.none)
            : e.fold(A.none, H(A.some(fm(e))), A.none, H(A.some(dm(e))))
        })
        .map(wm(n, r))
        .getOrThunk(function () {
          ...
          return s.isSome() && e.isSome()
            ? Mf.findRootInline(u, a, o)
                .map(function (e) {
                  return (
                    (o = e),
                    !!su(
                      [hl.firstPositionIn(o), hl.lastPositionIn(o)],
                      function (e, t) {
                        var n = Mf.normalizePosition(!0, e),
                          r = Mf.normalizePosition(!1, t)
                        return hl
            ...
            : e
                .bind(function (e) {
                  return t.map(function (e) {
                    return i ? Nm(n, r, o, e) : Nm(n, r, e, o), !0
                  })
                })
                .getOr(!1)
        })
    ...
    Tm = kr('start', 'end'),
    km = kr('rng', 'table', 'cells'),
    Am = hd([{ removeTable: ['element'] }, { emptyCells: ['cells'] }]),
    Rm = function (e, t) {
    ...
    Bm = function (e, n) {
      return _m(e.start(), n).bind(function (t) {
        return _m(e.end(), n).bind(function (e) {
        ...
        : su([t, n], Tm).fold(
            ...
            function (e) {
              return Lm(r, e)
                ? A.none()
                : ((n = r),
                  _m((t = e).start(), n).bind(function (e) {
                    return te(Om(e)).map(function (e) {
                      return Tm(t.start(), e)
                    })
                  }))
    ...
    Im = function (e, t) {
      ...
      return ((r = t),
      (o = u),
      (i = Rm(r.startContainer, o)),
      (a = Rm(r.endContainer, o)),
      su([i, a], Tm)
        .filter(Dm)
        .filter(function (e) {
          return Lm(o, e)
    ...
    Fm = function (n) {
      return ((r = n),
      su(
        [Mm(r.cells(), r.rng().start()), Mm(r.cells(), r.rng().end())],
        function (e, t) {
        ...
        return e.length === t.length
          ? Am.removeTable(n.table())
          : Am.emptyCells(e)
      })
      var r
    },
    Um = function (e, t) {
      return Im(e, t).bind(Fm)
    },
    zm = function (e) {
      var t = []
    ...
    Km = Wm,
    Xm = function (e) {
      return Wm(Vm(e.selection.getSel()), er.fromDom(e.getBody()))
    },
    Ym = function (e, t) {
      return F(t, df), e.selection.setCursorLocation(t[0].dom(), 0), !0
    },
    Gm = function (e, t) {
      return _d(e, !1, t), !0
    },
    ...
    Zm = function (e, t) {
      return V(nd(t, e), function (e) {
        return 'caption' === sr.name(e)
      })
    },
    eg = function (e, t) {
      return df(t), e.selection.setCursorLocation(t.dom(), 0), A.some(!0)
    },
    tg = function (u, s, c, l, f) {
      return hl
        ...
        .bind(function (e) {
          return (
            ...
            hl
              ...
              : ((t = l),
                (n = e),
                Zm(s, er.fromDom(n.getNode())).map(function (e) {
                  return !1 === Fr.eq(e, t)
                }))
          )
          var t, n, r, o, i, a
      ...
      return Qm(s, e).bind(function (e) {
        return Kf(e)
          ...
          : ((t = a),
            ...
            (o = e),
            (i = c),
            hl.navigate(r, t.getBody(), i).bind(function (e) {
              return Qm(n, er.fromDom(e.getNode())).map(function (e) {
                return !1 === Fr.eq(e, o)
              })
            }))
        var t, n, r, o, i
    ...
    og = function (e, t) {
      ...
      return e.selection.isCollapsed() && 0 === s.length
        ...
        : ((n = e),
          ...
          0 !== (a = Xm(n)).length ? Ym(n, a) : Jm(n, o, i, r))
    },
    ig = function (e, t) {
    ...
    yg = function (e, t, n, r) {
      ...
      if (
        ...
        if (c && (u = o.childNodes[0 < i ? i - 1 : 0])) {
          if (Ba(u)) return A.none()
          if (s[u.nodeName] || hg(u)) return A.none()
        }
        if (o.hasChildNodes()) {
          if (
          ...
          if (
            ...
            return A.none()
          if (o.hasChildNodes() && !1 === hg(o)) {
            a = new oo((u = o), g)
            do {
              if (Do.isContentEditableFalse(u) || Ba(u)) {
                p = !1
                break
              }
      ...
      return (
        ...
        c &&
          ...
          bg(e, l, t, !1, o).each(function (e) {
            ;(o = e.container()), (i = e.offset()), (p = !0)
          }),
        p ? A.some(ku(o, i)) : A.none()
      )
    },
    Cg = function (e, t) {
      var n = t.collapsed,
    ...
    Sg = function (e, t) {
      Tg(e.getBody(), t) || Ti.after(er.fromDom(t), er.fromTag('br'))
      var n = er.fromTag('br')
      Ti.after(er.fromDom(t), n),
        xg(e.dom, e.selection, n.dom()),
        wg(e.dom, e.selection, n.dom(), !1),
        e.undoManager.add()
    },
    Tg = function (e, t) {
      return (
    ...
    Ag = function (e) {
      return e.fold(H(!1), kg, kg, H(!1))
    },
    Rg = function (e, t) {
      t.fold(v, b(Eg, e), b(Sg, e), v)
    },
    _g = function (e, t) {
      var n,
        r,
        ...
        i =
          ((n = e),
          (r = b(Mf.isInlineTarget, n)),
          (o = _u.fromRangeStart(n.selection.getRng())),
          cm(r, n.getBody(), o).filter(Ag))
      i.isSome() ? i.each(b(Rg, e)) : Ng(e, t)
    },
    Dg = hd([
      { before: ['element'] },
      { on: ['element', 'offset'] },
    ...
    Pg = kr('start', 'soffset', 'finish', 'foffset'),
    Lg = {
      domRange: Og.domRange,
      relative: Og.relative,
      exact: Og.exact,
      exactFromRange: function (e) {
        return Og.exact(e.start(), e.soffset(), e.finish(), e.foffset())
      },
      range: Pg,
      getWin: function (e) {
        var t = e.match({
    ...
    Ig = Qn.detect().browser,
    Mg = function (e, t) {
      var n = sr.isText(t) ? Wl(t).length : $r.children(t).length + 1
      return n < e ? n : e < 0 ? 0 : e
    },
    Fg = function (e) {
      return Lg.range(
        e.start(),
        Mg(e.soffset(), e.start()),
        e.finish(),
        Mg(e.foffset(), e.finish())
      )
    },
    Ug = function (e, t) {
    ...
    zg = function (t) {
      return function (e) {
        return Ug(t, e.start()) && Ug(t, e.finish())
      }
    },
    Vg = function (e) {
      return !0 === e.inline || Ig.isIE()
    },
    qg = function (e) {
      return Lg.range(
    ...
    jg = function (e) {
      ...
      return Hg(t.dom()).filter(zg(e))
    },
    $g = function (e, t) {
      return A.from(t).filter(zg(e)).map(Fg)
    },
    Wg = function (e) {
    ...
    Kg = function (e) {
      return (e.bookmark ? e.bookmark : A.none())
        .bind(b($g, er.fromDom(e.getBody())))
        .bind(Wg)
    },
    Xg = function (e) {
      var t = Vg(e) ? jg(er.fromDom(e.getBody())) : A.none()
      e.bookmark = t.isSome() ? t : e.bookmark
    },
    Yg = function (t) {
      Kg(t).each(function (e) {
  ...
  function np(s) {
    ...
    var r = function (e) {
      ...
      e = function (e, n) {
        ;(n = n || 'exec'),
          Qg(e, function (t, e) {
            Qg(e.toLowerCase().split(','), function (e) {
              c[n][e] = t
            })
          })
      },
    ...
    e({
      ...
      'JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone':
        function (e) {
          var t = e.substring(7)
          'full' === t && (t = 'justify'),
            Qg('left,center,right,justify'.split(','), function (e) {
      ...
      FontName: function (e, t, n) {
        var r, o
        ;(o = n),
          (r = s).formatter.toggle('fontname', { value: dg(r, o) }),
          r.nodeChanged()
      },
      FontSize: function (e, t, n) {
        var r, o
        ;(o = n),
          (r = s).formatter.toggle('fontsize', { value: dg(r, o) }),
          r.nodeChanged()
      },
  ...
  var ip,
    ap = function (n) {
      return (
        n._eventDispatcher ||
          (n._eventDispatcher = new op({
            scope: n,
            toggleEvent: function (e, t) {
              op.isNative(e) && n.toggleNativeEvent && n.toggleNativeEvent(e, t)
            },
          })),
        n._eventDispatcher
      )
    ...
    up = {
      fire: function (e, t, n) {
        ...
        if (((t = ap(this).fire(e, t, n)), !1 !== n && this.parent))
    ...
    bp = function (e, t) {
      return 'selectionchange' === t
        ...
        ? (e.eventRoot || (e.eventRoot = vp.select(e.settings.event_root)[0]),
          e.eventRoot)
        : e.getBody()
    },
    yp = function (e, t, n) {
        ...
        if (((e = bp(i, a)), i.settings.event_root)) {
          if (
            (ip ||
              ...
              i.editorManager.on('removeEditor', function () {
                var e
                if (!i.editorManager.activeEditor && ip) {
                  for (e in ip) i.dom.unbind(bp(i, e))
                  ip = null
                }
              })),
            ip[a])
          ...
          ;(t = function (e) {
            for (
              ...
              var o = n[r].getBody()
              ;(o === t || vp.isChildOf(t, o)) && yp(n[r], a, e)
            }
          }),
            (ip[a] = t),
            vp.bind(e, a, t)
    ...
    wp = (xp = Yt.extend({}, up, xp)),
    Np = Yt.each,
    Ep = Yt.explode,
    Sp = { f9: 120, f10: 121, f11: 122 },
    Tp = Yt.makeMap('alt,ctrl,shift,meta,access')
  function kp(i) {
    var a = {},
      r = [],
      u = function (e) {
        ...
        return (
          (r.id = t.join(',')),
          r.access && ((r.alt = !0), _e.mac ? (r.ctrl = !0) : (r.shift = !0)),
          r.meta && (_e.mac ? (r.meta = !0) : ((r.ctrl = !0), (r.meta = !1))),
          r
        )
      },
      s = function (e, t, n, r) {
        var o
        return (
          ((o = Yt.map(Ep(e, '>'), u))[o.length - 1] = Yt.extend(
            o[o.length - 1],
            { func: n, scope: r || i }
          )),
    ...
    i.on('keyup keypress keydown', function (t) {
      ...
      (this.add = function (e, n, r, o) {
        ...
        return (
          ...
          Np(Ep(Yt.trim(e.toLowerCase())), function (e) {
            var t = s(e, n, r, o)
            a[t.id] = t
          }),
          !0
  ...
  var Ap = function (e) {
    ...
    _p = function (t) {
      return Ap($r.owner(t)).filter(function (e) {
    ...
    Dp = function (t, e) {
      return ((n = e),
      n.collapsed
        ? A.from(iu(n.startContainer, n.startOffset)).map(er.fromDom)
    ...
    Pp = function (e) {
      var t,
        n = e.getBody()
      return n && ((t = er.fromDom(n)), Rp(t) || _p(t).isSome())
    },
    Lp = function (e) {
      return e.inline
        ? Pp(e)
        : (t = e).iframeElement && Rp(er.fromDom(t.iframeElement))
      var t
    },
    Ip = function (e) {
      ...
      e.removed ||
        (t
          ...
          : (function (t) {
              ...
              if (t.$.contains(r, u)) return Op(u), Bp(t, o), Ip(t)
              t.bookmark !== undefined &&
                !1 === Lp(t) &&
                Gg(t).each(function (e) {
                  t.selection.setRng(e), (o = e)
                }),
                n || (_e.opera || Op(r), t.getWin().focus()),
                (_e.gecko || n) && (Op(r), Bp(t, o)),
                Ip(t)
            })(e))
    },
    Fp = Lp,
    ...
    $p = function (e, t, n) {
      var r,
        ...
        p =
          ...
          {
            x: i - (r ? u.left + o.dom().clientLeft + jp(o) : 0),
            y: a - (r ? u.top + o.dom().clientTop + Hp(o) : 0),
          })
      return (
        (c = p.x),
        (l = p.y),
  ...
  function Xp(r) {
    ...
    return (
      ...
      }),
      {
        windows: o,
        open: function (e, t) {
          r.editorManager.setActive(r), Xg(r)
          var n = i().open(e, t, s)
          return u(n), n
        },
  ...
  var Yp = Ni.PluginManager,
    Gp = function (e, t) {
      var n = (function (e, t) {
        for (var n in Yp.urls)
          if (Yp.urls[n] + '/plugin' + t + '.js' === e) return n
        return null
      })(t, e.suffix)
      return n
    ...
    var n,
      ...
      w = function (t) {
        return (
          ...
          (0 !== t.getAttribute('src').indexOf('data:') || mc(u)(t))
        )
      },
      N = function () {
        var o, i, a
        return (
          ...
          r.findAll(u.getBody(), w).then(
            g(function (e) {
              return (
                (e = U(e, function (e) {
                  return 'string' != typeof e || (th(u, e), !1)
                })),
                F(e, function (e) {
  ...
  var Ch = function (e, t) {
    ...
    xh = function (e, t) {
      if (Do.isText(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || Ch(e, t.nextSibling))
        )
          return !0
      }
      return !1
      ...
      if (
        ...
        v &&
          ...
          p.isValidChild(l, f.toLowerCase()) &&
            ...
            (C = b),
            (x = v),
            !M(td(er.fromDom(x), er.fromDom(C)), function (e) {
              return Ch(y, e.dom())
            }))))
      ) {
        var y, C, x, w, N
        for (
          ...
          if (
            ((w = h),
            (N = v),
            Do.isText(N) || (Do.isElement(N) && !Ch(w, N) && !Tl(N)))
          ) {
            if (xh(h, v)) {
    ...
    Nh = function (e) {
      e.settings.forced_root_block && e.on('NodeChange', b(wh, e))
    },
    Eh = function (t) {
      ...
      do {
        ...
        if (a[n.nodeName] && !/^(TD|TH)$/.test(n.nodeName))
          return void (r
            ...
            ? t.setEndBefore(n)
            : t.setEndAfter(n))
        if (_e.ie && _e.ie < 11 && e.isBlock(n) && e.isEmpty(n))
    ...
    'onselectionchange' in i.getDoc() ||
      i.on('NodeChange Click MouseUp KeyUp Focus', function (e) {
        ...
        ;(n = {
          ...
          ('nodechange' !== e.type && mg(n, r)) || i.fire('SelectionChange'),
          (r = n)
      }),
      ...
      i.on('SelectionChange', function () {
        ...
        !e ||
          (!_e.range && i.selection.isCollapsed()) ||
          (Ah(i) &&
            !(function (e) {
              var t, n
              if (
  ...
  var _h,
    ...
    Oh = function (e, t) {
      return (
        (n = (u = e).inline ? Bh(u.getBody()) : { left: 0, top: 0 }),
        (a = (i = e).getBody()),
        (r = i.inline
          ...
          pageX:
            (o = (function (e, t) {
              if (t.target.ownerDocument !== e.getDoc()) {
                var n = Bh(e.getContentAreaContainer()),
                  r =
                    ((i = (o = e).getBody()),
    ...
    Ph = Do.isContentEditableFalse,
    Lh = Do.isContentEditableTrue,
    Ih = function (e) {
    ...
    Mh = function (u, s) {
      return function (e) {
        if (0 === e.button) {
          var t = jt.find(s.dom.getParents(e.target), Na.or(Ph, Lh))
          if (((i = s.getBody()), Ph((a = t)) && a !== i)) {
      ...
      ;(t = pi.DOM),
        ...
        (r = function (e) {
          ...
          if (p.dragging) {
            var g =
              ((f = p),
              { pageX: (d = Oh(h, e)).pageX - f.relX, pageY: d.pageY + 5 })
            ;(c = p.ghost),
              (l = h.getBody()),
        ...
        (u = c),
        (i = function () {
          u.dragging && s.fire('dragend'), Uh(u)
        }),
        (s = e).on('mousedown', n),
        e.on('mousemove', r),
        e.on('mouseup', o),
        ...
        (n = e).on('drop', function (e) {
          var t =
            'undefined' != typeof e.clientX
              ...
              : null
          ;(Ph(t) || Ph(n.dom.getContentEditableParent(t))) &&
            e.preventDefault()
        })
    },
    qh = function (e) {
  ...
  ;((Dh = _h || (_h = {}))[(Dh.Up = -1)] = 'Up'), (Dh[(Dh.Down = 1)] = 'Down')
  var Hh = function (o, i, a, e, u, t) {
      var n,
        s,
        c = 0,
        l = [],
      ...
      return (
        (s = jt.last(t.getClientRects())) &&
          (r((n = t.getNode())),
          (function (e, t, n, r) {
            for (; (r = Kc(r, e, Ja, t)); ) if (n(r)) return
          })(o, e, r, n)),
        l
      )
    },
    jh = b(Hh, _h.Up, nu, ru),
    $h = b(Hh, _h.Down, ru, nu),
    Wh = function (n) {
      return function (e) {
        return (t = n), e.line > t
        var t
    ...
    Zh = function (e, o) {
      return jt.reduce(e, function (e, t) {
        var n, r
        return (
          (n = Math.min(Gh(e, o), Jh(e, o))),
          (r = Math.min(Gh(t, o), Jh(t, o))),
          Qh(o, t)
            ? t
            : Qh(o, e)
            ? e
    ...
    ev = function (e, t, n, r) {
      for (; (r = Yh(r, e, Ja, t)); ) if (n(r)) return
    },
    tv = function (e, t, n) {
      var r,
        o,
        ...
        l,
        f = qh(
          ((o = e), jt.filter(jt.toArray(o.getElementsByTagName('*')), Ic))
        ),
      ...
      return (r = Zh(d, t)) &&
        (r = Zh(
          ...
          (c = []).push((s = r)),
          ev(_h.Up, u, b(l, nu), s.node),
          ev(_h.Down, u, b(l, ru), s.node),
          c),
          t
        )) &&
        Ic(r.node)
        ? ((a = t), { node: (i = r).node, before: Gh(i, a) < Jh(i, a) })
        : null
    },
    nv = function (i, a, e) {
      return (
    ...
    rv = function (t) {
      var e = Di(function () {
        if (!t.removed && t.selection.getRng().collapsed) {
          var e = ps(t, t.selection.getRng(), !1)
          t.selection.setRng(e)
        }
      }, 0)
      t.on('focus', function () {
    ...
    ov = {
      ...
      metaKeyPressed: function (e) {
        return _e.mac ? e.metaKey : e.ctrlKey && !e.altKey
      },
    },
    iv = Do.isContentEditableTrue,
    av = Do.isContentEditableFalse,
    uv = ul,
    sv = al,
    cv = function (e, t) {
      for (var n = e.getBody(); t && t !== n; ) {
        if (iv(t) || av(t)) return t
        t = t.parentNode
      }
      return null
    },
      ...
      var p,
        ...
        c = function (e, t) {
          ...
          if (e.collapsed) {
            if (!y(e))
              if (!1 === t) {
                if (((c = b(-1, e)), Ic(c.getNode(!0))))
                  return v(-1, c.getNode(!0), !1, !1)
                if (Ic(c.getNode())) return v(-1, c.getNode(), !c.isAtEnd(), !1)
              } else {
                if (((c = b(1, e)), Ic(c.getNode())))
                  return v(1, c.getNode(), !c.isAtEnd(), !1)
                if (Ic(c.getNode(!0))) return v(1, c.getNode(!0), !1, !1)
              }
            return null
          }
          return (
        ...
        l = function () {
          p &&
            ...
            na(er.fromDom(g.getBody()), '#' + h).each(_i.remove),
            (p = null)),
            na(er.fromDom(g.getBody()), '#' + h).each(_i.remove),
            (p = null)
        },
        ...
        _e.ceFalse &&
          ((function () {
            g.on('mouseup', function (e) {
              var t = s()
              t.collapsed && $p(g, e.clientX, e.clientY) && u(gs(g, t, !1))
            }),
              g.on('click', function (e) {
                var t
                ;(t = cv(g, e.target)) &&
                  (av(t) && (e.preventDefault(), g.focus()),
                  iv(t) && g.dom.isChildOf(t, g.selection.getNode()) && l())
              }),
            ...
            var n,
              ...
              i = function (e, t) {
                ...
                return (
                  !(!o || !g.dom.isChildOf(o, i) || !1 !== av(cv(g, o))) ||
                  (o &&
                    ((n = o),
                    (r = i),
                    !(
            ...
            ;(r = !1),
              ...
              n.on('touchend', function (e) {
                var t = cv(n, e.target)
                av(t) && (r || (e.preventDefault(), c(ms(n, t))))
              }),
              g.on('mousedown', function (e) {
                ...
                if (
                  ...
                  !1 !== $p(g, e.clientX, e.clientY)
                )
                  if ((t = cv(g, n)))
                    av(t)
                      ? (e.preventDefault(), c(ms(g, t)))
                      : (l(),
                        (iv(t) && e.shiftKey) ||
                          nv(e.clientX, e.clientY, g.selection.getRng()) ||
                          (C(), g.selection.placeCaretAt(e.clientX, e.clientY)))
                  else if (!1 === Ic(n)) {
                    l(), C()
                    var r = tv(a, e.clientX, e.clientY)
              ...
              g.on('keypress', function (e) {
                ov.modifierPressed(e) ||
                  (e.keyCode, av(g.selection.getNode()) && e.preventDefault())
              }),
              ...
              g.on('copy', function (e) {
                var t,
                  n = e.clipboardData
                if (!e.isDefaultPrevented() && e.clipboardData && !_e.ie) {
                  var r = (t = g.dom.get(h))
          ...
          )),
        {
          ...
          showBlockCaretContainer: function (e) {
            e.hasAttribute('data-mce-caret') &&
              (Ua(e), u(s()), g.selection.scrollIntoView(e[0]))
          },
          hideFakeCaret: C,
          destroy: function () {
            o.destroy(), (p = null)
    ...
    return {
      parse: function (e) {
        ...
        for (
          ...
          if ((_ < t.index && q(O(e.substr(_, t.index - _))), (n = t[6])))
            ':' === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), I(n)
          else if ((n = t[7])) {
            if (t.index + t[0].length > e.length) {
              q(O(e.substr(t.index))), (_ = t.index + t[0].length)
              continue
            }
            if (
              ...
              if (
                ...
                if ((h = d.map['data-mce-bogus'])) {
                  if ('all' === h) {
                    ;(_ = fv(U, e, S.lastIndex)), (S.lastIndex = _)
                    continue
                  }
                  f = !1
                }
        ...
        for (_ < e.length && q(O(e.substr(_))), o = D.length - 1; 0 <= o; o--)
  ...
  var mv = dv,
    ...
    pv = { trimExternal: gv, trimInternal: gv },
    hv = 0,
    vv = 2,
    bv = 1,
    yv = function (g, p) {
    ...
    wv = function (e) {
      return jt.filter(jt.map(e.childNodes, Cv), function (e) {
        return 0 < e.length
      })
    },
    Nv = function (e, t) {
    ...
    Av = function (e) {
      var t = er.fromTag(
        'body',
        Ev.get().getOrThunk(function () {
          var e = document.implementation.createHTMLDocument('undo')
          return Ev.set(A.some(e)), e
        })
      )
      return Ca(t, kv(e)), F(Ki(t, '*[data-mce-bogus]'), _i.unwrap), ya(t)
    },
    Rv = function (n) {
      var e, t, r
      return (
    ...
    return (
      ...
      (o = {
        ...
        beforeChange: function () {
          f() && (s = Gu.getUndoBookmark(u.selection))
        },
        add: function (e, t) {
          var n,
            r,
          ...
          ;(e.bookmark = Gu.getUndoBookmark(u.selection)),
        ...
        undo: function () {
          ...
          return (
            ...
            0 < c &&
              ((e = l[--c]), _v(u, e, !0), d(!0), u.fire('undo', { level: e })),
            e
          )
        },
        redo: function () {
          ...
          return (
            c < l.length - 1 &&
              ((e = l[++c]), _v(u, e, !1), d(!0), u.fire('redo', { level: e })),
            e
          )
        },
        clear: function () {
        ...
        hasUndo: function () {
          return 0 < c || (o.typing && l[0] && !Dv(Rv(u), l[0]))
        },
        hasRedo: function () {
    ...
    Mv = function (t, e, n, r) {
      ...
      return (
        ...
        ((e = t.dom.getParent(e, function (e) {
          return !!Iv(t, e, n) || e.parentNode === o || !!zv(t, e, n, r, !0)
        })),
        zv(t, e, n, r))
      )
    },
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              ...
              if (
                (!o || n.exact) &&
                !Lv(u, _l.normalizeStyleValue(e, _l.replaceVars(c[a], i), a))
              )
                return
            }
        } else
    ...
    Vv = {
      ...
      match: function (e, t, n, r) {
        ...
        return r
          ...
          : ((r = e.selection.getNode()),
            !!Mv(e, r, t, n) ||
              !((o = e.selection.getStart()) === r || !Mv(e, o, t, n)))
      },
        ...
        return (
          ...
          r.dom.getParent(
            ...
            function (e) {
              var t, n
              for (t = 0; t < o.length; t++)
                (n = o[t]), !u[n] && zv(r, e, n, i) && ((u[n] = !0), a.push(n))
            },
            r.dom.getRoot()
          ),
          a
      ...
      matchesUnInheritedFormatSelector: Iv,
    },
    qv = function (e, t) {
      ...
      return (
        t === r && Do.isText(t)
          ? 0 < n &&
            ...
            ((t = (r = qv(t, n)).previousSibling),
            n < o
              ? ((t = r = qv(r, (o -= n)).previousSibling),
          ...
          : (Do.isText(t) &&
            ...
            Do.isText(r) &&
              0 < o &&
              o < r.nodeValue.length &&
              (o = (r = qv(r, o).previousSibling).nodeValue.length)),
    ...
    Yv = function (e, t, n, r) {
      ...
      ;(o = t.getRng(!0)),
        ...
        Wv(n)
          ...
          : ((u = Kv(n)) && u.nodeValue.charAt(0) === jv && u.deleteData(0, 1),
            (a = u),
            o.startContainer === a &&
              0 < o.startOffset &&
            ...
            e.remove(n, !0)),
        i && e.isEmpty(i) && df(er.fromDom(i)),
        t.setRng(o)
    },
    Gv = function (e, t, n, r, o) {
      if (r) Yv(t, n, r, o)
      else if (!(r = Zu(e, n.getStart())))
        for (; (r = t.get($v)); ) Yv(t, n, r, !1)
    },
    Jv = function (e, t, n) {
      var r = e.dom,
        o = r.getParent(n, Na.curry(_l.isTextBlock, e))
      o && r.isEmpty(o)
    ...
    Zv = function (e, t) {
      var n,
        ...
        o =
          ...
          r)
      return Qv(o, o.ownerDocument.createTextNode(jv))
    },
    eb = function (e) {
      var i = e.dom,
        a = e.selection,
      ...
      e.on('mouseup keydown', function (e) {
        ...
        ;(t = u),
          ...
          8 === o &&
            r.isCollapsed() &&
            r.getStart().innerHTML === jv &&
            Gv(t, n, r, Zu(t, r.getStart())),
          (37 !== o && 39 !== o) || Gv(t, n, r, Zu(t, r.getStart()))
      })
    },
    tb = function (e, t) {
      return (
  ...
  var ib = function (e, t) {
    ...
    db = function (e, t, n, r) {
      return (
        !(t = _l.getNonWhiteSpaceSibling(t, n, r)) ||
        'BR' === t.nodeName ||
        e.isBlock(t)
      )
    },
    mb = function (e, n, r, o, i) {
      var t,
        a,
        u,
        s,
      ...
      if ('all' !== n.remove)
        for (
          ub(n.styles, function (e, t) {
            ;(e = _l.normalizeStyleValue(y, _l.replaceVars(e, r), t)),
              'number' == typeof t && ((t = e), (i = 0)),
              (n.remove_similar || !i || sb(_l.getStyle(y, i, t), e)) &&
                y.setStyle(o, t, ''),
              (u = 1)
          }),
            u &&
            ...
            ub(n.attributes, function (e, t) {
              var n
              if (
                ((e = _l.replaceVars(e, r)),
                'number' == typeof t && ((t = e), (i = 0)),
                !i || sb(y.getAttrib(i, t), e))
              ) {
                if (
                  'class' === t &&
                  (e = y.getAttrib(o, t)) &&
                  ((n = ''),
                  ub(e.split(/\s+/), function (e) {
                    ;/mce\-\w+/.test(e) && (n += (n ? ' ' : '') + e)
                  }),
                  n)
                )
                ...
                'class' === t && o.removeAttribute('className'),
                  ab.test(t) && o.removeAttribute('data-mce-' + t),
                  o.removeAttribute(t)
              }
            }),
            ub(n.classes, function (e) {
              ;(e = _l.replaceVars(e, r)),
      ...
      return 'none' !== n.remove
        ? ((d = e),
          ...
          g.block &&
            (b
              ? h === v.getRoot() &&
                ((g.list_block && sb(m, g.list_block)) ||
                  ub(Yt.grep(m.childNodes), function (e) {
                    _l.isValid(d, b, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = fb(v, e, b)),
              ...
              : v.isBlock(m) &&
                !v.isBlock(h) &&
                (db(v, m, !1) ||
                  db(v, m.firstChild, !0, 1) ||
                  m.insertBefore(v.create('br'), m.firstChild),
                db(v, m, !0) ||
                  db(v, m.lastChild, !1, 1) ||
                  m.appendChild(v.create('br')))),
          (g.selector && g.inline && !sb(g.inline, m)) || v.remove(m, 1),
          !0)
        : void 0
    },
    gb = mb,
    pb = function (s, c, l, e, f) {
      var t,
        n,
        d = s.formatter.get(c),
        m = d[0],
        ...
        i = function (e) {
          var n,
            ...
            u =
              ...
              (o = l),
              (i = f),
              ub(_l.getParents(n.dom, t.parentNode).reverse(), function (e) {
                var t
                a ||
                  '_start' === e.id ||
                  '_end' === e.id ||
                  ((t = Vv.matchNode(n, e, r, o, i)) &&
                    !1 !== t.split &&
                    (a = e))
              }),
              a)
        ...
        g = function (e) {
          ...
          if (
            ...
            for (n = 0, r = d.length; n < r && !mb(s, d[n], l, e, e); n++);
          if (m.deep && t.length) {
        ...
        p = function (e) {
          ...
          return (
            Tl(n) && (n = n[e ? 'firstChild' : 'lastChild']),
            Do.isText(n) &&
              0 === n.data.length &&
              (n = e
        ...
        o = function (e) {
          ...
          if (((e = ql(s, e, d, !0)), m.split)) {
            if (((e = Hv(e)), (t = lb(s, e, !0)) !== (n = lb(s, e)))) {
              if (
            ...
            ub(e, function (e) {
              g(e),
                Do.isElement(e) &&
                  ...
                  e.parentNode &&
                  'underline' === _l.getTextDecoration(u, e.parentNode) &&
                  mb(
                    s,
                    {
                      deep: !1,
      ...
      if (e)
        ...
        !u.select('td[data-mce-selected],th[data-mce-selected]').length
          ? (function (e, t, n, r) {
              ...
              if (c)
                if (u) {
                  ...
                  var p = ql(e, g, e.formatter.get(t), !0)
                  ;(p = Hv(p)), e.formatter.remove(t, n, p), d.moveToBookmark(a)
                } else {
                  l = Zu(e.getBody(), c)
                  var h = Xv(!1).dom(),
                    v = Zv(m, h)
          ...
          : ((t = Gu.getPersistentBookmark(s.selection, !0)),
            o(r.getRng()),
            r.moveToBookmark(t),
            m.inline &&
              Vv.match(s, c, l, r.getStart()) &&
              _l.moveStart(u, r, r.getRng()),
            s.nodeChanged())
      else {
        e = r.getNode()
        for (
          var h = 0, v = d.length;
          h < v && (!d[h].ceFalseOverride || !mb(s, d[h], l, e, e));
          h++
        );
      }
    },
    hb = Yt.each,
    vb = function (e) {
      return e && 1 === e.nodeType && !Tl(e) && !Qu(e) && !Do.isBogus(e)
    },
    bb = function (e, t) {
      var n
      for (n = e; n; n = n[t]) {
        if (3 === n.nodeType && 0 !== n.nodeValue.length) return e
        if (1 === n.nodeType && !Tl(n)) return n
      }
      return e
    },
    yb = function (e, t, n) {
    ...
    Cb = function (e, t, n) {
      hb(e.childNodes, function (e) {
        vb(e) && (t(e) && n(e), e.hasChildNodes() && Cb(e, t, n))
      })
    },
    xb = function (n, e) {
      return b(function (e, t) {
        return !(!t || !_l.getStyle(n, t, e))
      }, e)
    },
    wb = function (r, e, t) {
      return b(
    ...
    Eb = function (e, t) {
      ...
      1 === t.nodeType &&
        ...
        ((n = _l.getTextDecoration(e, t.parentNode)),
    ...
    Sb = function (n, e, r, o) {
      hb(e, function (t) {
        hb(n.dom.select(t.inline, o), function (e) {
          vb(e) && gb(n, t, r, e, t.exact ? e : null)
        }),
          (function (r, e, t) {
            if (e.clear_child_styles) {
              var n = e.links ? '*:not(a)' : '*'
              hb(r.select(n, t), function (n) {
                vb(n) &&
                  hb(e.styles, function (e, t) {
                    r.setStyle(n, t, '')
                  })
              })
            }
    ...
    Tb = function (e, t, n, r) {
      ;(t.styles.color || t.styles.textDecoration) &&
        (Yt.walk(r, b(Eb, e), 'childNodes'), Eb(e, r))
    },
    kb = function (e, t, n, r) {
      t.styles &&
        ...
        Cb(
          r,
          xb(e, 'fontSize'),
          wb(e, 'backgroundColor', _l.replaceVars(t.styles.backgroundColor, n))
        )
    },
    Ab = function (e, t, n, r) {
      ;('sub' !== t.inline && 'sup' !== t.inline) ||
        (Cb(r, xb(e, 'fontSize'), wb(e, 'fontSize', '')),
        e.remove(e.select('sup' === t.inline ? 'sub' : 'sup', r), !0))
    },
    Rb = function (e, t, n, r) {
      r &&
        !1 !== t.merge_siblings &&
        ((r = yb(e, _l.getNonWhiteSpaceSibling(r), r)),
        (r = yb(e, r, _l.getNonWhiteSpaceSibling(r, !0))))
    },
    _b = function (t, n, r, o, i) {
      ;(Vv.matchNode(t, i.parentNode, r, o) && gb(t, n, o, i)) ||
        (n.merge_with_parents &&
          t.dom.getParent(i.parentNode, function (e) {
            if (Vv.matchNode(t, e, r, o)) return gb(t, n, o, i), !0
          }))
    },
    Db = Yt.each,
    Bb = function (g, p, h, r) {
          ...
          if (((e = e || b), n)) {
            if (
              ...
              Db(e.styles, function (e, t) {
                i.setStyle(n, t, _l.replaceVars(e, h))
              }),
              e.styles)
            ) {
            ...
            Db(e.attributes, function (e, t) {
              i.setAttrib(n, t, _l.replaceVars(e, h))
            }),
              Db(e.classes, function (e) {
                ;(e = _l.replaceVars(e, h)),
        ...
        a = function (s, e, t, c) {
          ...
          ;(l = b.inline || b.block),
            ...
            jl(s, e, function (e) {
              var a,
                u = function (e) {
                  ...
                  if (b.wrapper && Vv.matchNode(g, e, p, h)) a = 0
                  else {
                    if (
                      m &&
                      !r &&
            ...
            !0 === b.links &&
              Db(d, function (e) {
                var t = function (e) {
                  'A' === e.nodeName && y(e, b), Db(Yt.grep(e.childNodes), t)
                }
                t(e)
              }),
            Db(d, function (e) {
          ...
          if (r)
            ...
            !(function (e, t, n) {
              ...
              ;(a = (r = c.getRng(!0)).startOffset),
                ...
                (o = Zu(e.getBody(), c.getStart())) && (i = Kv(o))
              var l,
                f,
                d = /[^\s\u00a0\u00ad\u200b\ufeff]/
              s &&
            ...
            g.settings.forced_root_block ||
              ...
              Bb(g, v[0].defaultBlock),
              g.selection.setRng(bf(g.selection.getRng())),
              (e = Gu.getPersistentBookmark(g.selection, !0)),
              a(i, ql(g, n.getRng(), v)),
              b.styles && Tb(i, b, h, u),
              n.moveToBookmark(e),
              _l.moveStart(i, n, n.getRng()),
              g.nodeChanged()
          }
          ib(p, g)
        }
    ...
    Lb = function (e, t, n, r, o) {
      ...
      null === t.get() &&
        ...
        a.on('NodeChange', function (n) {
          var r = _l.getParents(a.dom, n.element),
            o = {}
          ;(r = Yt.grep(r, function (e) {
            return 1 === e.nodeType && !e.getAttribute('data-mce-bogus')
          })),
            Pb(i.get(), function (e, n) {
              Pb(r, function (t) {
                return a.formatter.matchNode(t, n, {}, e.similar)
                  ? (u[n] ||
                    ...
                    (o[n] = e),
                    !1)
                  : !Vv.matchesUnInheritedFormatSelector(a, t, n) && void 0
              })
            }),
            Pb(u, function (e, t) {
              o[t] ||
    ...
    Ub = function (e, t) {
      var n,
        ...
        g = function (e) {
          ...
          return (
            ...
            (t = Fb.create(o.name)),
            (n = t),
            (r = o).classes.length && Fb.addClass(n, r.classes.join(' ')),
            Fb.setAttribs(n, r.attrs),
            t
          )
        },
        p = function (n, e, t) {
          ...
          return (
            ...
            t &&
              (r || (r = Fb.create('div')).appendChild(n),
      ...
      return e && e.length
        ? ((o = e[0]),
          (n = g(o)),
          (r = Fb.create('div')).appendChild(p(n, e.slice(1), o.siblings)),
          r)
        : ''
    },
    zb = function (e) {
      ...
      return 'preview' in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || 'span'),
          (i = Vb(e.selector)).length
            ? (i[0].name || (i[0].name = t), (t = e.selector), (r = Ub(i, n)))
            : (r = Ub([t], n)),
          (o = Fb.select(t, r)[0] || r.firstChild),
          Mb(e.styles, function (e, t) {
            ;(e = c(e)) && Fb.setStyle(o, t, e)
          }),
          Mb(e.attributes, function (e, t) {
            ;(e = c(e)) && Fb.setAttrib(o, t, e)
          }),
          Mb(e.classes, function (e) {
            ;(e = c(e)), Fb.hasClass(o, e) || Fb.addClass(o, e)
          }),
          n.fire('PreviewFormats'),
          Fb.setStyles(r, { position: 'absolute', left: -65535 }),
          n.getBody().appendChild(r),
          (a = Fb.getStyle(n.getBody(), 'fontSize', !0)),
          (a = /px$/.test(a) ? parseInt(a, 10) : 0),
          Mb(u.split(' '), function (e) {
            var t = Fb.getStyle(o, e, !0)
            if (
              !(
                ('background-color' === e &&
                  /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                  ((t = Fb.getStyle(n.getBody(), e, !0)),
                  '#ffffff' === Fb.toHex(t).toLowerCase())) ||
                ('color' === e && '#000000' === Fb.toHex(t).toLowerCase())
              )
            ) {
    ...
    Hb = function (e, t, n, r, o) {
      var i = t.get(n)
      !Vv.match(e, n, r, o) || ('toggle' in i[0] && !i[0].toggle)
        ? Ob.applyFormat(e, n, r, o)
        : pb(e, n, r, o)
    },
    jb = function (e) {
  ...
  function $b(e) {
    ...
    return (
      ...
      eb(e),
      {
        ...
        apply: b(Ob.applyFormat, e),
        remove: b(pb, e),
        toggle: b(Hb, e, o),
        match: b(Vv.match, e),
        matchAll: b(Vv.matchAll, e),
        matchNode: b(Vv.matchNode, e),
        canApply: b(Vv.canApply, e),
        formatChanged: b(Lb, e, i),
        getCssText: b(qb, e),
      }
    )
  }
  var Wb,
    ...
    Xb =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var o = e[r]
          for (var i in o) Kb.call(o, i) && (n[i] = Wb(n[i], o[i]))
        }
        return n
      }),
    Yb = {
    ...
    Qb = function (e, t) {
      ...
      t.convert_fonts_to_spans &&
        Jb(e, r, Yt.explode(t.font_size_legacy_values)),
        (n = r),
    ...
    ry = (function () {
      ...
      return (
        (a.create = function (e, t) {
          var n, r
          if (((n = new a(e, ty[e] || 1)), t)) for (r in t) n.attr(r, t[r])
          return n
        }),
        ...
        (a.prototype.getAll = function (e) {
          var t,
            n = []
          for (t = this.firstChild; t; t = ny(t, this))
            t.name === e && n.push(t)
          return n
        }),
        (a.prototype.empty = function () {
          var e, t, n
          if (this.firstChild) {
            for (e = [], n = this.firstChild; n; n = ny(n, this)) e.push(n)
            for (t = e.length; t--; )
              (n = e[t]).parent =
                n.firstChild =
                n.lastChild =
        ...
        (a.prototype.isEmpty = function (e, t, n) {
          ...
          if (((t = t || {}), i))
            do {
              ...
              if (3 === i.type && !ey.test(i.value)) return !1
              if (
                3 === i.type &&
                i.parent &&
                t[i.parent.name] &&
    ...
    oy = function (e, t, n, r) {
      ;(e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new ry('br', 1)).shortEnded = !0)
        : (r.empty().append(new ry('#text', 3)).value = '\xa0')
    },
    iy = function (e) {
      return ay(e, '#text') && '\xa0' === e.firstChild.value
    },
    ay = function (e, t) {
      return (
        e &&
            ...
            if (
              ...
              o &&
                ...
                uy(h, m, g, i) &&
                  ...
                  (c.removeEmpty ? i.remove() : c.paddEmpty && oy(p, n, d, i)))
            } else {
              for (
                a = o;
                i &&
              ...
              a === i &&
                ...
                (((l = new ry('#text', 3)).value = '\xa0'), o.replace(l))
            }
        }),
  ...
  function gy(T, k) {
      ...
      e = {
        ...
        parse: function (e, a) {
          ...
          ;(a = a || {}),
            ...
            (D = {}),
            (l = my(
              ly('script,style,head,html,body,title,meta,param'),
              k.getBlockElements()
            ))
          ...
          t = mv(
            {
              ...
              text: function (e, t) {
                ...
                f ||
                  ((e = e.replace(x, ' ')),
                  sy(d.lastChild, l) && (e = e.replace(y, ''))),
                  0 !== e.length &&
              ...
              start: function (e, t, n) {
                ...
                if ((n = h ? k.getElementRule(e) : {})) {
                  ...
                  n.paddEmpty && (iy(d) || uy(k, g, b, d)) && oy(T, a, l, d),
                    (d = d.parent)
                }
              },
            },
          ...
          var S = (d = new ry(a.context || T.root_name, 11))
          if (
            (t.parse(e),
            h &&
              m.length &&
              (a.context
                ...
                : (function (e) {
                    ...
                    for (
                      d = ly('tr,td,th,tbody,thead,tfoot,table'),
    ...
    return cy(e, T), Zb.register(e, T), e
  }
  var py = function (e, t, n) {
    ...
    hy = function (e, t, n) {
      var r = ka(n.getInner ? t.innerHTML : e.getOuterHTML(t))
      return n.selection || Co(er.fromDom(t)) ? r : Yt.trim(r)
    },
    vy = function (e, t, n) {
      var r = n.selection ? Xb({ forced_root_block: !1 }, n) : n,
        o = e.parse(t, r)
      return Yb.trimTrailingBr(o), o
    },
    by = function (e, t, n, r, o) {
      var i,
        ...
        u,
        s,
        c = ((i = r), hf(t, n).serialize(i))
      return (
        (a = e),
        (s = c),
        !(u = o).no_events && a ? cp(a, Xb(u, { content: s })).content : s
      )
    }
  function yy(e, t) {
    var a,
      ...
      r =
        ...
        Yb.register(l, a, s),
        {
          ...
          serialize: function (e, t) {
            var n = Xb({ format: 'html' }, t || {}),
              r = Gb.process(u, e, n),
              o = hy(s, r, n),
              i = vy(l, o, n)
            return 'tree' === n.format ? i : by(u, a, c, i, n)
          },
          addRules: function (e) {
  ...
  function Cy(e) {
    return { getBookmark: b(El, e), moveToBookmark: b(Sl, e) }
  }
  ;(Cy || (Cy = {})).isBookmarkNode = Tl
  var xy = Cy,
    wy = Do.isContentEditableFalse,
    Ny = Do.isContentEditableTrue,
    Ey = function (r, a) {
      var u,
        s,
        c,
      ...
      a.contentStyles.push(
        e +
          ...
          (_e.gecko ? '' : 'outline: 1px dashed black;') +
        ...
        O = function (e) {
          ...
          ;(t = e.screenX - d),
            ...
            (_(u) && !1 !== a.settings.resize_img_proportional
              ? !ov.modifierPressed(e)
              : ov.modifierPressed(e) || (_(u) && f[2] * f[3] != 0)) &&
              (k(t) > k(n)
                ? ((C = A(y * b)), (y = A(C / b)))
                : ((y = A(C / b)), (C = A(y * b)))),
    ...
    Py = function (e, t) {
      for (var n = e.rows(), r = 0; r < n.length; r++)
        for (var o = n[r].cells(), i = 0; i < o.length; i++)
          if (Fr.eq(o[i], t)) return A.some(Dy(i, r))
      return A.none()
    },
      ...
      return ((t = e), (n = o[0]), ta(n, 'table', b(Fr.eq, t)))
        .bind(function (e) {
          var t = o[0],
            n = o[o.length - 1],
            r = Iy(e)
          return Fy(r, t, n).map(function (e) {
            return Ay([My(e)])
          })
        })
        .getOrThunk(Vy)
    ...
    jy = function (e, t) {
      ...
      return 0 < o.length
        ? Hy(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? Vy() : qy(n, r[0]))
    },
    $y = function (e, t) {
      var n,
        r = e.selection.getRng(),
      ...
      if ('text' === t.format)
        return e.selection.isCollapsed()
          ? ''
          : ka(r.text || (i.toString ? i.toString() : ''))
      r.cloneContents
        ? (n = t.contextual
            ? jy(er.fromDom(e.getBody()), a).dom()
    ...
    Xy = function (e, t, n) {
      return Ky(e, t, !0, n, function (e, t) {
        return Math.min($r.childNodesCount(e), t)
      })
    },
    Yy = function (e, t, n) {
      return Ky(e, t, !1, n, function (e, t) {
        return 0 < t ? t - 1 : t
      })
    },
    Gy = function (e, t) {
    ...
    eC = function (u, s, e, c) {
      var n,
        ...
        m = function () {
          ...
          if (c.bookmark !== undefined && !1 === Fp(c)) {
            var i = Gg(c)
            if (i.isSome())
              return i
                .map(function (e) {
        ...
        i = function (e, t) {
          ...
          if (
            (o = e) &&
            (Qy(o) || (Zy(o.startContainer) && Zy(o.endContainer)))
          ) {
            var o,
              i = Qy(e) ? e : null
            if (i) {
        ...
        p = {
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r =
                      r.length === i ? Gy(r.nextSibling, !0) : r.parentNode),
                    (o = 0 === a ? Gy(o.previousSibling, !1) : o.parentNode),
                    r && r === o))
                    ? r
                    : n && 3 === n.nodeType
                    ? n.parentNode
          ...
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              ...
              if (
                ((i = e.getRoot()),
                (n = e.getParent(n || Xy(i, t, t.collapsed), e.isBlock)),
                (r = e.getParent(r || Yy(i, t, t.collapsed), e.isBlock)),
                n && n !== i && a.push(n),
                n && r && n !== r)
              )
    ...
    aC = function (e, t, n, r) {
      var o,
        ...
        l = e === Au.Forwards,
        f = l ? oC : rC
      return !r.collapsed && ((o = nC(r)), tC(o))
        ? ds(e, t, o, e === Au.Backwards, !0)
        : ((u = _a(r.startContainer)),
          f((i = il(e, t.getBody(), r)))
            ? ms(t, i.getNode(!l))
            : (i = n(i))
            ? f(i)
              ? ds(e, t, i.getNode(!l), l, !0)
              : f((a = n(i))) &&
                ((!(c = Yc((s = i), a)) && Do.isBr(s.getNode())) || c)
              ? ds(e, t, a.getNode(!l), l, !0)
              : u
              ? ps(t, i.toRange(), !0)
              : null
            : u
    ...
    uC = function (e, t, n, r) {
      ...
      if (
        ((d = nC(r)),
        (o = il(e, t.getBody(), r)),
        (i = n(t.getBody(), Wh(1), o)),
        (a = jt.filter(i, Kh(1))),
        (s = jt.last(o.getClientRects())),
        (oC(o) || sl(o)) && (d = o.getNode()),
        (rC(o) || cl(o)) && (d = o.getNode(!0)),
        !s)
      )
        return null
      if (((c = s.left), (u = Zh(a, c)) && tC(u.node)))
        return (
          (l = Math.abs(c - u.left)),
      ...
      if (d) {
        var m = (function (e, t, n, r) {
          ...
          1 === e
            ? ((o = l.next), (i = ru), (a = nu), (u = _u.after(r)))
            : ((o = l.prev), (i = nu), (a = ru), (u = _u.before(r))),
            (c = m(u))
          do {
        ...
        if ((u = Zh(jt.filter(m, Kh(1)), c)))
          return ps(t, u.position.toRange(), !0)
        if ((u = jt.last(jt.filter(m, Kh(0)))))
          return ps(t, u.position.toRange(), !0)
      }
    },
    sC = function (e, t, n) {
      var r,
        ...
        a,
        u = As(e.getBody()),
        s = Na.curry(iC, u.next),
        c = Na.curry(iC, u.prev)
      if (n.collapsed && e.settings.forced_root_block) {
        ...
        ;(1 === t ? s(_u.fromRangeStart(n)) : c(_u.fromRangeStart(n))) ||
          ...
          (!_e.ie || 11 <= _e.ie) && (a.innerHTML = '<br data-mce-bogus="1">'),
          (o = a),
      ...
      return function () {
        var e,
          ...
          c =
            ((t = f),
            (r = As((e = l).getBody())),
            (o = Na.curry(iC, r.next)),
            (i = Na.curry(iC, r.prev)),
            (a = t ? Au.Forwards : Au.Backwards),
            (u = t ? o : i),
            (s = e.selection.getRng()),
            (n = aC(a, e, u, s)) ? n : (n = sC(e, a, s)) || null)
      ...
      return function () {
        var e,
          ...
          a =
            ...
            (n = uC(r, e, o, i)) ? n : (n = sC(e, r, i)) || null)
    ...
    gC = function (i, a) {
      i.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          mC(
            [
              { keyCode: ov.RIGHT, action: cC(t, !0) },
              { keyCode: ov.LEFT, action: cC(t, !1) },
              { keyCode: ov.UP, action: lC(t, !1) },
              { keyCode: ov.DOWN, action: lC(t, !0) },
              { keyCode: ov.RIGHT, action: Dc(t, !0) },
              { keyCode: ov.LEFT, action: Dc(t, !1) },
              { keyCode: ov.UP, action: Bc(t, !1) },
              { keyCode: ov.DOWN, action: Bc(t, !0) },
              { keyCode: ov.RIGHT, action: xm.move(t, n, !0) },
              { keyCode: ov.LEFT, action: xm.move(t, n, !1) },
              {
                keyCode: ov.RIGHT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
                action: xm.moveNextWord(t, n),
              },
              {
                keyCode: ov.LEFT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
                action: xm.movePrevWord(t, n),
              },
            ],
            r
          ).each(function (e) {
    ...
    vC = function (n, r) {
      ...
      return te(i)
        .map(function (e) {
          var t = _u.fromRangeStart(n.selection.getRng())
          return !!zf(r, t, e.dom()) && (hC(r, n, e, i), !0)
        })
        .getOr(!1)
    },
    bC = function (e, t) {
      return !!e.selection.isCollapsed() && vC(e, t)
    },
    yC = function (o, i) {
      o.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          mC(
            [
              { keyCode: ov.BACKSPACE, action: dC(Od, t, !1) },
              { keyCode: ov.DELETE, action: dC(Od, t, !0) },
              { keyCode: ov.BACKSPACE, action: dC(Sm, t, n, !1) },
              { keyCode: ov.DELETE, action: dC(Sm, t, n, !0) },
              { keyCode: ov.BACKSPACE, action: dC(og, t, !1) },
              { keyCode: ov.DELETE, action: dC(og, t, !0) },
              { keyCode: ov.BACKSPACE, action: dC(pd, t, !1) },
              { keyCode: ov.DELETE, action: dC(pd, t, !0) },
              { keyCode: ov.BACKSPACE, action: dC(fd, t, !1) },
              { keyCode: ov.DELETE, action: dC(fd, t, !0) },
              { keyCode: ov.BACKSPACE, action: dC(bC, t, !1) },
              { keyCode: ov.DELETE, action: dC(bC, t, !0) },
            ],
            r
          ).each(function (e) {
            r.preventDefault()
        ...
        o.on('keyup', function (e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            mC(
              [
                { keyCode: ov.BACKSPACE, action: dC(Pd, t) },
                { keyCode: ov.DELETE, action: dC(Pd, t) },
              ],
              n
            ))
        })
    ...
    _C = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        var s,
          c,
          l = o ? t(o) : i.create('BR')
        if (RC(n, r, !0) && RC(n, r, !1))
          TC(n, 'LI') ? i.insertAfter(l, AC(n)) : i.replace(l, n)
        else if (RC(n, r, !0))
          TC(n, 'LI')
            ? (i.insertAfter(l, AC(n)),
              l.appendChild(i.doc.createTextNode(' ')),
              l.appendChild(n))
            : n.parentNode.insertBefore(l, n)
        else if (RC(n, r, !1)) i.insertAfter(l, AC(n))
        else {
          n = AC(n)
          var f = a.cloneRange()
    ...
    PC = function (e, t, n) {
      return !1 === Do.isText(t)
        ? n
        : e
        ? 1 === n && t.data.charAt(n - 1) === Ta
          ? 0
          : n
        : n === t.data.length - 1 && t.data.charAt(n) === Ta
        ? t.data.length
        : n
    },
    LC = function (e, t) {
    ...
    MC = function (a, e) {
      var t,
        ...
        S = function (e) {
          ...
          if (BC(s, 'TABLE') || BC(s, 'HR')) return (g && !e) || (!g && e)
          for (
            t = new oo(s, c),
              Do.isText(s) &&
                (e && 0 === o
        ...
        T = function () {
          ;(r = /^(H[1-6]|PRE|FIGURE)$/.test(f) && 'HGROUP' !== d ? E(m) : E()),
            lc(a) && OC(C, l) && C.isEmpty(c)
              ? (r = C.split(l, c))
              : C.insertAfter(r, c),
            xC(a, r)
        }
      Cg(C, N).each(function (e) {
        ...
        (u = LC(C, s)) &&
          (((m && !n) || (!m && n)) &&
            (s = (function (e, t, n, r, o) {
              var i,
                ...
                m = e.dom,
                g = LC(m, r)
              if (!(a = m.getParent(r, m.isBlock)) || !OC(m, a)) {
                if (
                  ((l =
                    (a = a || g) === e.getBody() ||
          ...
          /^(LI|DT|DD)$/.test(f) && C.isEmpty(c)
            ...
            : (m && c === a.getBody()) ||
              ((m = m || 'P'),
              _a(c)
                ? ((r = Ua(c)), C.isEmpty(c) && DC(c), xC(a, r))
                : S()
                ? T()
                : S(!0)
                ...
                : ((t = ((b = N),
                  ...
                  y.setStart(
                    b.startContainer,
                    PC(!0, b.startContainer, b.startOffset)
                  ),
                  y.setEnd(b.endContainer, PC(!1, b.endContainer, b.endOffset)),
                      ...
                      for (r = i.length; r--; )
                        ...
                        (o.firstChild === o.lastChild &&
                          ...
                          : (a = o) &&
                            'A' === a.nodeName &&
                            0 ===
                              Yt.trim(ka(a.innerText || a.textContent))
                                .length &&
                            e.remove(o)
                      var a
                    }
                  ...
                  C.isEmpty(c) && DC(c),
                  r.normalize(),
                  C.isEmpty(r) ? (C.remove(r), T()) : xC(a, r)),
              C.setAttrib(r, 'id', ''),
    ...
    GC = function (e) {
      var t = ic(e),
        n = wC(e.dom, e.selection.getStart())
    ...
    QC = function (e, t) {
      return $d(
        [
          JC([qC], VC.none()),
          JC([$C('summary', !0)], VC.br()),
          JC([WC(!0), KC(!1), YC], VC.br()),
          JC([WC(!0), KC(!1)], VC.block()),
          JC([WC(!0), KC(!0), YC], VC.block()),
          JC([WC(!0), KC(!0)], VC.br()),
          JC([jC(!0), YC], VC.br()),
          JC([jC(!0)], VC.block()),
          JC([HC(!0), YC, GC], VC.block()),
          JC([HC(!0)], VC.br()),
          JC([XC], VC.br()),
          JC([HC(!1), YC], VC.br()),
          JC([GC], VC.block()),
    ...
    rx = function (e) {
      return (
        !!e.selection.isCollapsed() &&
        ((t = e),
        (n = b(Mf.isInlineTarget, t)),
        (r = _u.fromRangeStart(t.selection.getRng())),
        cm(n, t.getBody(), r).map(b(tx, t, r)).getOr(!1))
      )
      var t, n, r
    },
    ox = function (r) {
      r.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          mC([{ keyCode: ov.SPACEBAR, action: dC(rx, t) }], n).each(function (
            e
          ) {
            n.preventDefault()
          }))
    ...
    ax = function (e, t) {
      ...
      if (r)
        return 'compositionstart' === t.type
          ? (t.preventDefault(), t.stopPropagation(), void ix(e, r))
          : void (Oa(r) && (ix(e, r), e.undoManager.add()))
    },
    ux = function (e) {
      e.on('keyup compositionstart', b(ax, e))
    },
    sx = function (e) {
      var t = xm.setupSelectedState(e)
      ux(e), gC(e, t), yC(e, t), ex(e), ox(e)
    }
  function cx(u) {
    var s,
      n,
        ...
        u.inline ||
          ...
          u.on('click', function (e) {
            ...
            if ('HTML' === e.target.nodeName) {
              if (11 < _e.ie) return void u.getBody().focus()
    ...
    return (
      ...
      _e.windowsPhone ||
        u.on(
          ...
          function (e) {
            ov.modifierPressed(e) || d.normalize()
          },
          !0
        ),
      m &&
  ...
  var lx = function (e) {
        ...
        3 <= e.detail &&
          (function (e) {
            ...
            if (ku.isElementPosition(n)) {
              var o = n.container()
              lx(o) &&
                hl.firstPositionIn(o).each(function (e) {
                  return t.setStart(e.container(), e.offset())
                })
            }
            ku.isElementPosition(r) &&
              ((o = n.container()),
              lx(o) &&
                hl.lastPositionIn(o).each(function (e) {
                  return t.setEnd(e.container(), e.offset())
                })),
              e.selection.setRng(bf(t))
          })(t)
      })
    },
    dx = function (e) {
    ...
    px = function (t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        f.content_editable &&
          (t.on('remove', function () {
            var e = this.getBody()
            mx.removeClass(e, 'mce-content-body'),
              mx.removeClass(e, 'mce-edit-focus'),
              mx.setAttrib(e, 'contentEditable', null)
          }),
          mx.addClass(d, 'mce-content-body'),
        ...
        t.readonly ||
          (t.inline &&
            'static' === mx.getStyle(n, 'position', !0) &&
        ...
        (t.parser =
          ((o = gy((u = t).settings, u.schema)).addAttributeFilter(
          ...
          o.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function (e) {
            for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--; )
              (t = e[n]).isEmpty(r) &&
                ...
                (t.append(new ry('br', 1)).shortEnded = !0)
          }),
          o)),
        (t.serializer = yy(f, t)),
        (t.selection = eC(t.dom, t.getWin(), t.serializer, t)),
        (t.annotator = Ql(t)),
        (t.formatter = $b(t)),
        (t.undoManager = Bv(t)),
        (t._nodeChangeDispatcher = new Rh(t)),
        (t._selectionOverrides = lv(t)),
        dx(t),
        fx(t),
        sx(t),
        Nh(t),
        ...
        f.browser_spellcheck ||
          f.gecko_spellcheck ||
          ((m.body.spellcheck = !1), mx.setAttrib(n, 'spellcheck', 'false')),
        (t.quirks = cx(t)),
        t.fire('PostRender'),
        ...
        0 < t.contentStyles.length &&
          ...
          t.dom.addStyle(r)),
        ((i = t),
        i.inline ? mx.styleSheetLoader : i.dom.styleSheetLoader).loadAll(
          t.contentCSS,
          function (e) {
            gx(t)
          },
    ...
    bx = function (e, t) {
      var n = vx(e, t)
      t.editorContainer &&
        ((hx.get(t.editorContainer).style.display = e.orgDisplay),
        (e.hidden = hx.isHidden(t.editorContainer))),
        (e.getElement().style.display = 'none'),
        hx.setAttrib(e.id, 'aria-hidden', 'true'),
        n || px(e)
    },
    yx = pi.DOM,
    Cx = function (t, n, e) {
      var r,
        ...
        i = rh.get(e)
      if (
        ((r = rh.urls[e] || t.documentBaseUrl.replace(/\/$/, '')),
        (e = Yt.trim(e)),
        i && -1 === Yt.inArray(n, e))
      ) {
        if (
          (Yt.each(rh.dependencies(e), function (e) {
            Cx(t, n, e)
          }),
          t.plugins[e])
        )
    ...
    Nx = function (e) {
      ...
      return e.inline
        ? wx(null)
        : ((t = r), (n = yx.create('div')), yx.insertAfter(n, t), wx(n))
    },
    Ex = function (e) {
      var t,
        n,
      ...
      return (
        ...
        k(d.theme)
          ? ((l = (o = e).settings),
            (f = o.getElement()),
            (i = l.width || yx.getStyle(f, 'width') || '100%'),
            (a = l.height || yx.getStyle(f, 'height') || f.offsetHeight),
            (u = l.min_height || 100),
            (s = /^[0-9\.]+(|px)$/i).test('' + i) &&
    ...
    Sx = function (t) {
      ...
      return (
        ...
        (u.aria_label =
          u.aria_label ||
          yx.getAttrib(s, 'aria-label', t.getLang('aria.rich_text_area'))),
        t.fire('ScriptsLoaded'),
        (o = (n = t).settings.theme),
        k(o)
          ? ((n.settings.theme = xx(o)),
            (r = oh.get(o)),
            (n.theme = new r(n, oh.urls[o])),
            n.theme.init &&
              n.theme.init(
                n,
                oh.urls[o] || n.documentBaseUrl.replace(/\/$/, ''),
                n.$
              ))
          : (n.theme = {}),
        (i = t),
        ...
        u.content_editable ? px(t) : bx(t, e)
      )
    },
    Tx = pi.DOM,
    kx = function (e) {
    ...
    Ax = function (i, a) {
      ...
      !(function (e, t, n, r) {
        var o = t.settings,
          i = o.theme
        if (k(i)) {
          if (!kx(i) && !oh.urls.hasOwnProperty(i)) {
            var a = o.theme_url
            a
              ? oh.load(i, t.documentBaseURI.toAbsolute(a))
              : oh.load(i, 'themes/' + i + '/theme' + n + '.js')
          }
        ...
        ;(e = u),
          ...
          Yt.each(r.external_plugins, function (e, t) {
            rh.load(t, e), (r.plugins += ' ' + t)
          }),
          Yt.each(r.plugins.split(/[ ,]/), function (e) {
            if ((e = Yt.trim(e)) && !rh.urls[e])
              if (kx(e)) {
                ...
                Yt.each(t, function (e) {
                  ...
                  ;(e = rh.createUrl(t, e)), rh.load(e.resource, e)
                })
              } else
                rh.load(e, {
                  prefix: 'plugins/',
    ...
    Rx = function (t) {
      var e = t.settings,
        n = t.id,
        r = function () {
          Tx.unbind(window, 'ready', r), t.render()
        }
      if (je.Event.domLoaded) {
        if (t.getElement() && _e.contentEditable) {
          e.inline
            ? (t.inline = !0)
            : ((t.orgVisibility = t.getElement().style.visibility),
              (t.getElement().style.visibility = 'hidden'))
          var o = t.getElement().form || Tx.getParent(n, 'form')
          o &&
            ((t.formElement = o),
            e.hidden_input &&
              !/TEXTAREA|INPUT/i.test(t.getElement().nodeName) &&
              (Tx.insertAfter(
                Tx.create('input', { type: 'hidden', name: n }),
                n
              ),
              (t.hasHiddenInput = !0)),
            ...
            Tx.bind(o, 'submit reset', t.formEventDelegate),
            t.on('reset', function () {
            ...
            (t.notificationManager = Kp(t)),
            'xml' === e.encoding &&
              t.on('GetContent', function (e) {
                e.save && (e.content = Tx.encode(e.content))
              }),
    ...
    Px = { ftp: 21, http: 80, https: 443, mailto: 25 },
    Lx = function (r, e) {
      var t,
        n,
        o = this
      if (
        ...
        0 !== r.indexOf('/') ||
          ...
          /^[\w\-]*:?\/\//.test(r) ||
            ((n = e.base_uri
              ? e.base_uri.path
              : new Lx(document.location.href).directory),
            '' == e.base_uri.protocol
  ...
  ;(Lx.prototype = {
    ...
    toRelative: function (e) {
      ...
      if ('./' === e) return e
      if (
        ('mce_host' !== (e = new Lx(e, { base_uri: this })).host &&
          this.host !== e.host &&
          e.host) ||
        this.port !== e.port ||
    ...
    toAbsolute: function (e, t) {
      return (e = new Lx(e, { base_uri: this })).getURI(
    ...
    (Lx.getDocumentBaseUrl = function (e) {
      var t
      return (
        (t =
  ...
  var Ix = function (e, t, n) {
      ...
      if (
        ...
        r = Yt.trim(pv.trimExternal(e.serializer, n.innerHTML))
      else if ('text' === t.format) r = ka(n.innerText || n.textContent)
      else {
    ...
    Mx = function (e, t) {
      t(e), e.firstChild && Mx(e.firstChild, t), e.next && Mx(e.next, t)
    },
    Fx = function (e, t, n) {
    ...
    zx = function (e, t) {
      ...
      e.dom.setHTML(e.getBody(), t),
        Fp((r = e)) &&
          hl.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(),
              n = Do.isTable(t) ? hl.firstPositionIn(t).getOr(e) : e
    ...
    Vx = function (u, s, c) {
      return (
        ...
        A.from(u.getBody()).fold(H(s), function (e) {
          return Ux(s)
            ? (function (e, t, n, r) {
                Fx(e.parser.getNodeFilters(), e.parser.getAttributeFilters(), n)
    ...
    jx = function (e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          e.hasHiddenInput && o && qx.remove(o.nextSibling),
          !e.inline &&
            r &&
            ((i = e), qx.setStyle(i.id, 'display', i.orgDisplay)),
          lp(e),
          e.editorManager.remove(e),
          qx.remove(e.getContainer()),
          Hx(t),
          Hx(n),
          e.destroy()
      }
        ...
        (t || e.removed
          ? (t ||
            ...
            (r = (n = e).formElement) &&
              ...
              qx.unbind(r, 'submit reset', n.formEventDelegate)),
    ...
    Jx = function (e, t, n) {
      ...
      ;(r = l),
        ...
        l.setDirty(!1),
        (l.plugins = {}),
        (l.documentBaseURI = new Lx(t.document_base_url, { base_uri: d })),
        (l.baseURI = d),
        (l.contentCSS = []),
        (l.contentStyles = []),
        (l.shortcuts = new kp(l)),
        (l.loadedCSS = {}),
        (l.editorCommands = new np(l)),
        (l.suffix = n.suffix),
        (l.editorManager = n),
        (l.inline = t.inline),
        (l.buttons = {}),
        (l.menuItems = {}),
        t.cache_suffix &&
          (_e.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, '')),
        !1 === t.override_viewport && (_e.overrideViewPort = !1),
  ...
  Kx(
    (Jx.prototype = {
      ...
      show: function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (Wx.show(this.getContainer()), Wx.hide(this.id)),
          this.load(),
          this.fire('show'))
      },
      hide: function () {
        var e = this,
          t = e.getDoc()
        e.hidden ||
          (Gx && t && !e.inline && t.execCommand('SelectAll'),
          e.save(),
          e.inline
            ? ((e.getBody().contentEditable = !1),
              e === e.editorManager.focusedEditor &&
                (e.editorManager.focusedEditor = null))
            : (Wx.hide(e.getContainer()),
              Wx.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'))
      },
      isHidden: function () {
          ...
          return (
            ...
            /TEXTAREA|INPUT/i.test(o.nodeName)
              ...
              : ((!e.is_removing && r.inline) || (o.innerHTML = t),
                (n = Wx.getParent(r.id, 'form')) &&
                  Xx(n.elements, function (e) {
      ...
      getContent: function (e) {
        return (
          ...
          A.from(t.getBody()).fold(
            H('tree' === n.format ? new ry('body', 11) : ''),
            function (e) {
              return Ix(t, n, e)
            }
          )
      ...
      getElement: function () {
        return (
          this.targetElm || (this.targetElm = Wx.get(this.id)), this.targetElm
        )
      },
      getWin: function () {
        var e
      ...
      addVisual: function (e) {
        ...
        ;(e = e || r.getBody()),
          ...
          Xx(i.select('table,a', e), function (e) {
            var t
            switch (e.nodeName) {
              case 'TABLE':
                return (
  ...
  var Qx,
    ...
    nw = function (n, e) {
      ...
      Qn.detect().browser.isIE()
        ...
        n.on('keyup nodechange', function (e) {
          var t
          ;('nodechange' === (t = e).type && t.selectionChange) || Xg(n)
        })
    },
    rw = function (e) {
      var t,
    ...
    ow = pi.DOM,
    iw = function (e) {
      return tw.isEditorUIElement(e)
    },
    aw = function (t, e) {
      var n = t ? t.settings.custom_ui_selector : ''
      return (
        null !==
        ow.getParent(e, function (e) {
    ...
    uw = function (r, e) {
      ...
      rw(t),
        ...
        Qx ||
          ...
          ow.bind(document, 'focusin', Qx))
    },
    sw = function (e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (ow.unbind(document, 'focusin', Qx), (Qx = null))
    },
    cw = function (e) {
      e.on('AddEditor', b(uw, e)), e.on('RemoveEditor', b(sw, e))
    },
    lw = {},
    fw = 'en',
    dw = {
      setCode: function (e) {
        e &&
          ((fw = e), (this.rtl = !!this.data[e] && 'rtl' === this.data[e]._dir))
      },
      getCode: function () {
        return fw
      },
      ...
      add: function (e, t) {
        var n = lw[e]
        for (var r in (n || (lw[e] = n = {}), t)) n[r] = t[r]
        this.setCode(e)
      },
      translate: function (e) {
        var t = lw[fw] || {},
    ...
    ww = function (e) {
      e !== bw &&
        (e
          ? pn(window).on('resize scroll', xw)
          : pn(window).off('resize scroll', xw),
        (bw = e))
    },
    Nw = function (t) {
      var e = Cw
      delete yw[t.id]
      for (var n = 0; n < yw.length; n++)
        if (yw[n] === t) {
          yw.splice(n, 1)
          break
        }
      return (
        ...
        ew.activeEditor === t &&
          (ew.activeEditor = 0 < Cw.length ? Cw[0] : null),
        ew.focusedEditor === t && (ew.focusedEditor = null),
        e.length !== Cw.length
      )
    }
  hw(
    (ew = {
      ...
      setup: function () {
        var e,
          ...
          o = ''
        if (
          ((t = Lx.getDocumentBaseUrl(document.location)),
          /^[^:]+:\/\/\/?[^\/]+\//.test(t) &&
            ((t = t.replace(/[\?#].*$/, '').replace(/[\/\\][^\/]+$/, '')),
            /[\/\\]$/.test(t) || (t += '/')),
        ...
        ;(this.baseURL = new Lx(t).toAbsolute(e)),
          (this.documentBaseURL = t),
          (this.baseURI = new Lx(this.baseURL)),
          (this.suffix = o),
          cw(this)
      },
      overrideDefaults: function (e) {
        var t, n
        ;(t = e.base_url) &&
          ((this.baseURL = new Lx(this.documentBaseURL).toAbsolute(
            t.replace(/\/+$/, '')
          )),
          (this.baseURI = new Lx(this.baseURL))),
          (n = e.suffix),
      ...
      init: function (r) {
        ...
        var c = function (e) {
            ...
            return (
              t ||
                ((t = (t = e.name) && !mw.get(t) ? e.name : mw.uniqueId()),
                e.setAttribute('id', t)),
              t
            )
          },
            ...
            mw.unbind(window, 'ready', e),
              ...
              (o = pn.unique(
                (function (t) {
                  ...
                  if (t.types)
                    return (
                      pw(t.types, function (e) {
                        n = n.concat(mw.select(e.selector))
                      }),
                      n
                    )
                  if (t.selector) return mw.select(t.selector)
                  ...
                  switch (t.mode) {
                    case 'exact':
                      0 < (e = t.elements || '').length &&
                        pw(gw(e), function (t) {
                          ...
                          ;(e = mw.get(t))
                            ? n.push(e)
                            : pw(document.forms, function (e) {
                                pw(e.elements, function (e) {
                                  e.name === t &&
                                    ((t = 'mce_editor_' + vw++),
                                    mw.setAttrib(e, 'id', t),
                                    n.push(e))
                    ...
                    case 'specific_textareas':
                      pw(mw.select('textarea'), function (e) {
              ...
              r.types
                ? pw(r.types, function (t) {
                    Yt.each(o, function (e) {
                      return (
                        !mw.is(e, t.selector) || (n(c(e), hw({}, r, t), e), !1)
                      )
                    })
                  })
                : (Yt.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          yw[e.id] === e ||
            (null === t.get(e.id) &&
              ('length' !== e.id && (yw[e.id] = e), yw.push(e), Cw.push(e)),
            ww(!0),
            (t.activeEditor = e),
            ...
            Zx ||
              ...
              mw.bind(window, 'beforeunload', Zx))),
          e
        )
      },
      createEditor: function (e, t) {
        return this.add(new Jx(e, t, this))
      },
      remove: function (e) {
        var t,
          n,
        ...
        if (e) {
          if (!k(e))
            return (
              ...
              D(r.get(n.id))
                ? null
                : (Nw(n) && r.fire('RemoveEditor', { editor: n }),
                  0 === Cw.length && mw.unbind(window, 'beforeunload', Zx),
                  n.remove(),
                  ww(0 < Cw.length),
                  n)
            )
          pw(mw.select(e), function (e) {
      ...
      execCommand: function (e, t, n) {
        ...
        switch (e) {
          case 'mceAddEditor':
            return this.get(n) || new Jx(n, this.settings, this).render(), !0
  ...
  function Tw(n) {
    return {
      ...
      normalize: function (t) {
        return Cg(n, t).fold(H(!1), function (e) {
          return (
  ...
  ;((Ew = Tw || (Tw = {})).compareRanges = mg),
    (Ew.getCaretRangeFromPoint = Ty),
    (Ew.getSelectedNode = ou),
    (Ew.getNode = iu)
  var kw,
    Aw,
    Rw = Tw,
    ...
    Lw = {
      inflate: function (e, t, n) {
        return Pw(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n)
      },
      relativePosition: Ow,
      ...
      intersect: function (e, t) {
        ...
        return (
          (n = Dw(e.x, t.x)),
          (r = Dw(e.y, t.y)),
          (o = _w(e.x + e.w, t.x + t.w)),
          (i = _w(e.y + e.h, t.y + t.h)),
          o - n < 0 || i - r < 0 ? null : Pw(n, r, o - n, i - r)
        )
      },
      ...
      fromClientRect: function (e) {
        return Pw(e.left, e.top, e.width, e.height)
      },
    },
    Iw = {},
    Mw = {
      ...
      has: function (e) {
        return !!Iw[e.toLowerCase()]
      },
      get: function (e) {
        var t = e.toLowerCase(),
          n = Iw.hasOwnProperty(t) ? Iw[t] : null
  ...
  zw.extend = kw = function (n) {
    ...
    (Aw = !1),
    n.Mixins &&
      (Fw(n.Mixins, function (e) {
        for (var t in e) 'init' !== t && (n[t] = e[t])
      }),
      o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
    n.Methods &&
      Fw(n.Methods.split(','), function (e) {
        n[e] = a
      }),
    n.Properties &&
      Fw(n.Properties.split(','), function (e) {
        var t = '_' + e
        n[e] = function (e) {
    ...
    n.Statics &&
      Fw(n.Statics, function (e, t) {
        i[t] = e
      }),
    n.Defaults && o.Defaults && (n.Defaults = Uw({}, o.Defaults, n.Defaults)),
    n))
      'function' == typeof (r = n[t]) && o[t] ? (e[t] = u(t, r)) : (e[t] = r)
    return (i.prototype = e), ((i.constructor = i).extend = kw), i
  }
  var Vw = Math.min,
    qw = Math.max,
    Hw = Math.round,
    ...
    Kw = {
      send: function (e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ''),
          Kw.fire('beforeInitialize', { settings: e }),
          (t = ih()))
        ) {
          if (
            ...
            (t = Kw.fire('beforeSend', { xhr: t, settings: e }).xhr).send(
              e.data
            ),
            !e.async)
          )
  ...
  var Xw,
    ...
    Qw = Yt.extend,
    Zw = function (e) {
      ;(this.settings = Qw({}, e)), (this.count = 0)
    }
  ;(Zw.sendRPC = function (e) {
    return new Zw().send(e)
  }),
    (Zw.prototype = {
      send: function (n) {
        var r = n.error,
          o = n.success
        ;((n = Qw(this.settings, n)).success = function (e, t) {
          void 0 === (e = $w.parse(e)) && (e = { error: 'JSON Parse error.' }),
            e.error
    ...
    ;(Yw = {}),
      ...
      (Jw = {
        ...
        setItem: function (e, t) {
          Gw.push(e), (Yw[e] = String(t))
        },
        key: function (e) {
          return Gw[e]
        },
        removeItem: function (t) {
          ;(Gw = Gw.filter(function (e) {
            return e === t
          })),
            delete Yw[t]
        },
      ...
      Object.defineProperty(Jw, 'length', {
        get: function () {
          return Gw.length
        },
        configurable: !1,
